...
class ControllerExtensionModuleAccount extends Controller {
    public function index(): string {
		...
		$data['order_cls'] = '';
		$data['password_cls'] = '';
		if ($currentRoute == 'account/account') {
			$data['account_cls'] = 'active';
		}
		if ($currentRoute == 'account/order') {
			$data['order_cls'] = 'active';
		}
		if ($currentRoute == 'account/password') {
			$data['password_cls'] = 'active';
		}
