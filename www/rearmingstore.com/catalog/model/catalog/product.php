    ...
    public function getProduct(int $product_id): array {
        ...
        if ($query->num_rows) {
            return [
                ...
                'timecomplete'      => $query->row['timecomplete'],
                'why'      => $query->row['why'],
                'payments'      => $query->row['payments'],
                ...
                'name_option_slider' => $query->row['name_option_slider'],
                'max_value_option_slider' => $query->row['max_value_option_slider'],
                'min_value_option_slider' => $query->row['min_value_option_slider'],
                'percent_value_slider' => $query->row['percent_value_slider'],
            ];
        } else {
            return [];
        }
