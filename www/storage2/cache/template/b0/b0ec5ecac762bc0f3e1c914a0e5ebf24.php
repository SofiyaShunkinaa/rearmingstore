...
class __TwigTemplate_ecc6cbdd12ae451d75f5bd121116ed48 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\tconsole.log(\"testing: \" + updatedPrice);
...
\tconsole.log(\$('#product input[type=\"hidden\"][data-prise]').first().attr('data-prise'))
\tconsole.log(getNum(initialPrice))
    // Округляем итоговую цену и выводим на страницу
    all_price = parseFloat(all_price).toFixed(2)-parseFloat(getNum(initialPrice)*0.01).toFixed(2);
