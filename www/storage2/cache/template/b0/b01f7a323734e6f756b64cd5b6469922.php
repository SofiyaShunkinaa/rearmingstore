...
class __TwigTemplate_474947d0f06d7fbd5e4d0c4107b6130f extends Template
{
    private $source;
    private $macros = [];
...
\tvar currentRBG = \$('.dropdown-item[data-name=\"Current RBG rating\"]').first().data('value').split('-')[1]
\tvar desiredRBG = \$('.dropdown-item[data-name=\"Desired RBG rating\"]').data('value')
\t\tconsole.log(\"current: \" + currentRBG + \" desired: \"+desiredRBG)\t\t\t\t\t\t\t\t\t\t
\t
\tfunction calcTimeByRatingSubstraction(currentRBG, desiredRBG){
\t\tconsole.log(\"current: \" + currentRBG + \" desired: \"+desiredRBG)\t\t\t\t\t\t\t\t\t\t
...
\t\t\t\t\tconsole.log(n);
\t\t\t\t\tcalcTimeByRatingSubstraction(null,n);
\t\t\t\t\tbreak;
\t\t\t\t}
\t\t});
\t});
