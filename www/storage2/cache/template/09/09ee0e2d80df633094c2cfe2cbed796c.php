...
class __TwigTemplate_c192072f20ef4c9cb123f6d80eea7cba extends Template
{
    private $source;
    private $macros = [];
...
.irs--round .irs-bar,
.irs--round .irs-line {
    background-color: #ffa500; /* Оранжевый цвет трека */
}

.irs--round .irs-from,
.irs--round .irs-to,
.irs--round .irs-single {
    background-color: #ffa500; /* Оранжевый цвет для значений */
}

/* Настройка цвета ползунка */
.irs--round .irs-handle {
    background-color: #ff8c00; /* Темно-оранжевый цвет для ползунка */
    border-color: #ff8c00;
}
#slider {
    width: 100%; 
...
\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["breadcrumb"]) {
            // line 88
            echo "\t\t\t\t\t";
            if (twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "href", [], "any", false, false, false, 88)) {
                // line 89
                echo "\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "href", [], "any", false, false, false, 89);
                echo "\"  class=\"breadcrumb-item\">";
                echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "text", [], "any", false, false, false, 89);
                echo "</a>
\t\t\t\t\t";
            } else {
                // line 91
                echo "\t\t\t\t\t\t<span class=\"breadcrumb-item active\">";
                echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "text", [], "any", false, false, false, 91);
                echo "</span>
\t\t\t\t\t";
            }
            // line 93
...
\t\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["prod_cat"]) {
                // line 114
                echo "\t\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["prod_cat"], "href", [], "any", false, false, false, 114);
                echo "\" class=\"btn btn-outline-primary form-check-label\">";
                echo twig_get_attribute($this->env, $this->source, $context["prod_cat"], "text", [], "any", false, false, false, 114);
                echo "</a>
\t\t\t\t\t\t";
            }
            $_parent = $context['_parent'];
...
\t\t\t\t\t\t";
        ...
        if (($context["tags_prod"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["tag_prod"]) {
                // line 144
                echo "\t\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "href", [], "any", false, false, false, 144);
                echo "\" class=\"btn btn-outline-primary form-check-label ";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "active", [], "any", false, false, false, 144);
                echo "\">";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "tag", [], "any", false, false, false, 144);
                echo "</a>
\t\t\t\t\t\t\t";
            }
            $_parent = $context['_parent'];
...
\t\t\t\t";
        ...
        if (($context["options"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
                // line 154
                echo "\t\t\t\t  <h3>";
                echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["option"], "product_option_value", [], "any", false, false, false, 154), "name", [], "any", false, false, false, 154);
                echo "</h3>
\t\t\t\t\t";
                // line 155
...
\t\t\t\t\t\t  <div class=\"borderedRow borderedRow-";
                    // line 158
                    echo twig_get_attribute($this->env, $this->source, $context["option"], "id", [], "any", false, false, false, 158);
                    echo "\">
\t\t\t\t\t\t\t<div>";
                    // line 159
...
\t\t\t\t\t\t\t<input name=\"option[";
                    ...
                    echo twig_get_attribute($this->env, $this->source, ($context["option_value"] ?? null), "name", [], "any", false, false, false, 160);
                    echo "\" data-value=\"";
                    echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["option"], "product_option_value", [], "any", false, false, false, 160), "name", [], "any", false, false, false, 160);
                    echo "\">
...
\t\t\t\t\t";
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 201) == "checkbox")) {
                    // line 202
                    echo "\t\t\t\t\t\t<div class=\"opt-checkbox\" ";
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 202) == "Select Dungeons")) {
                        echo "id=\"hidden-options-checkbox\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 202) == "Specific Slot")) {
                        echo "id=\"specific-gear-slot\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 202) == "Specific Item Slot")) {
...
\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" ";
                        // line 207
                        if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 207), [0 => "Select Dungeons", 1 => "Speecific Item Slot", 2 => "Specific Slot"])) {
...
\t\t\t\t\t";
                ...
                // line 219
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 219) == "text")) {
                    // line 220
...
\t\t\t\t\t";
                ...
                // line 225
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 225) == "textarea")) {
                    // line 226
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t";
                ...
                // line 271
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 271) == "choice")) {
                    // line 272
                    echo "\t\t\t\t\t  <div class=\"row\">
\t\t\t\t\t\t<div class=\"col-md-12\">
...
\t\t\t\t\t\t\t<input type=\"number\" id=\"sliderValue\" style=\"text-align:center; border:none;\"
\t\t\t\t\t\t\t\tmin=\"";
            // line 297
...
\t\t\t\$(\"#sliderValue\").val(data.from);  // Инициализация значения при загрузке
\t\t},
\t\tonChange: function (data) {
\t\t\t\$(\"#sliderValue\").val(data.from);  // Обновление значения при изменении
\t\t},
\t\thide_min_max: true,
    });
...
";
    ...
    {
        return array (  3933 => 3424,  2372 => 1866,  2368 => 1865,  2364 => 1864,  1111 => 614,  1104 => 610,  1020 => 529,  1011 => 523,  1003 => 518,  831 => 349,  824 => 345,  817 => 341,  791 => 318,  784 => 314,  780 => 313,  777 => 312,  767 => 306,  762 => 304,  758 => 303,  750 => 298,  746 => 297,  740 => 294,  735 => 291,  732 => 290,  729 => 289,  723 => 288,  718 => 286,  702 => 272,  699 => 271,  685 => 264,  678 => 262,  671 => 261,  668 => 260,  654 => 253,  647 => 251,  640 => 250,  637 => 249,  623 => 242,  616 => 240,  609 => 239,  606 => 238,  598 => 235,  590 => 234,  586 => 233,  579 => 232,  576 => 231,  564 => 228,  558 => 227,  551 => 226,  548 => 225,  536 => 222,  530 => 221,  523 => 220,  520 => 219,  516 => 217,  507 => 213,  500 => 211,  498 => 210,  494 => 209,  488 => 208,  470 => 207,  466 => 205,  462 => 204,  458 => 203,  445 => 202,  442 => 201,  438 => 199,  429 => 195,  422 => 193,  420 => 192,  416 => 191,  410 => 190,  396 => 189,  392 => 187,  388 => 186,  384 => 185,  381 => 184,  378 => 183,  369 => 176,  361 => 173,  354 => 171,  352 => 170,  348 => 169,  336 => 168,  333 => 167,  329 => 166,  325 => 165,  311 => 160,  307 => 159,  303 => 158,  299 => 156,  297 => 155,  292 => 154,  287 => 153,  285 => 152,  278 => 147,  275 => 146,  262 => 144,  257 => 143,  255 => 142,  247 => 137,  240 => 133,  234 => 129,  224 => 127,  221 => 126,  211 => 124,  209 => 123,  202 => 118,  198 => 116,  187 => 114,  183 => 113,  180 => 112,  178 => 111,  162 => 98,  156 => 94,  150 => 93,  144 => 91,  136 => 89,  133 => 88,  129 => 87,  122 => 83,  37 => 1,);
    }
