...
class __TwigTemplate_68d6e6d55ce494459a5734a2de119d56 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tif(desiredR>=1900 && hours >= 16 || days != 1 && hours != 14){
\t\t\t\tdays++;
\t\t\t\thours = 0;
\t\t\t} else if(desiredR>=1900 && hours < 16){
\t\t\t\tif(currentR<=1600 && hours <= 6){
\t\t\t\t\thours = 0;
\t\t\t\t}
\t\t\t}
