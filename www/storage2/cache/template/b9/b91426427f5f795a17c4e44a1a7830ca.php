...
class __TwigTemplate_81d5ad170f7119aa4147a39f5515b8bb extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t} else{
\t\t\t\t\tif(desiredR>2100){
\t\t\t\t\t\tif(desiredR>currentR && current<2100){
...
\t\t\t\t\t\t\t\thoursTotal+=24;
\t\t\t\t\t\t\t} 
\t\t\t\t\t\t} else if(desiredR>currentR && current>=2100){
