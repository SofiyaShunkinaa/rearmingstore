...
class __TwigTemplate_93ed621f6899c4213d3152316dd25cde extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\thoursTotal = deltaTimes1*3 + deltaTimes2*32;
\t\t\t\t\t}
\t\t\t\t} else{
\t\t\t\t\tif(desiredR>2100){
