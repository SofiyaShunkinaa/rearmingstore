...
class __TwigTemplate_b65c5019858ab0f018a7818be72e7f87 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\ttimeUnits.minute = 0;
\t\t}
\t\tconsole.log(timeUnits.day, timeUnits.hour)
