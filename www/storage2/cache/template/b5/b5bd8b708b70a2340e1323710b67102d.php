...
class __TwigTemplate_e4b5ed492220adb0b8d3ba5e0e20d351 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tconsole.log(parseInt(\$('#comlete-time-text').attr('data-hours')))
