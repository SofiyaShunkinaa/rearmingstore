...
class __TwigTemplate_cc2db17acaa02704016c8655c7d69eb0 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\ttext = \"1 day\"
\t\t}
\t\telse if(optionName >= 1 && optionName < 6){
\t\t\ttext = (maxDays - optionName) +\" days\";
\t\t}
\t\telse if(optionName >= 6 && optionName < 16){
\t\t\ttext = (maxDays - optionName - 1) +\" days\";
\t\t}
\t\telse if(optionName >= 16 && optionName < 19){
\t\t\ttext =  (maxDays - optionName - 2) +\" days\";
\t\t}
\t\t\$('#comlete-time-text').text(text+\" order completion\");
\t}
