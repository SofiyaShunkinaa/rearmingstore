...
class __TwigTemplate_8ad3f09408587436e7b81f8486319777 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t} else if(desiredR>=1900 && desiredR != \"1400\"){console.log(123)
\t\t\t\tif (currentR < 1500){
\t\t\t\t\t
