...
class __TwigTemplate_af51f79d00789b4ef224ddef649d867f extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<label for=\"slider\">";
        ...
        echo " <span id=\"sliderValue\">50</span></label>
\t\t\t\t\t\t\t<input type=\"range\" 
\t\t\t\t\t\t\t\tmin=\"";
        // line 272
