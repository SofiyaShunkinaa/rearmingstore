...
class __TwigTemplate_611658b37538c9896829ae286f6f08c8 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\tif(currentR<=1600 && hours < 16 && hours !=14){
\t\t\t\t\thours = 0;
\t\t\t\t}
\t\t\t}
