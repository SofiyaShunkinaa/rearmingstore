...
class __TwigTemplate_6a8b3a3acf286c3019b4a0f536504450 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tlet mins = hours == 0 ? minutes : hours%60;
\t\t\tconsole.log(\"mins: \"+mins+\" minutes: \"+minutes)
\t\t\t\$('#comlete-time-text').text(hours+(hours==1?\" day\" : \" days \")+(mins >0 ? mins+\" minutes \" : \"\")+\"order completion\");
\t\t}
\t\telse{
\t\t\t\$('#comlete-time-text').text(count+(count==1?\" day\" : \" days\"));
\t\t}
...
\t\t\t\t\tbreak;
\t\t\t\tcase [\"Wrathion Reputation Boost\", \"Sabellian Reputation Boost\", \"The Cobalt Assembly Reputation Boost\", \"Winterpelt Furbolg Reputation Boost\"].includes(productName):
