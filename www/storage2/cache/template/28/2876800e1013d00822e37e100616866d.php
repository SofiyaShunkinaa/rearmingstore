...
class __TwigTemplate_885a55a91eec13d488e703bcfedb2fc0 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tmonths = Number(Math.floor(totalWeight/720))
\t\t\tdays = Number(Math.floor((totalWeight%720)/24))
\t\t\thours =  Number(Math.floor((totalWeight%720)%24))
...
\t\t\tlet extra = parseInt(\$('#comlete-time-text').attr('data-days')) || 10;
