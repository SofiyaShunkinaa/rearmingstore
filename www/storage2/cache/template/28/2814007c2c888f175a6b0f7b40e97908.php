...
class __TwigTemplate_fed1692d4be56d7e390fafb32cb5d004 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\tcurrentRBG = \$(this).first().data('value');
\t\t\t}
\t\t\tconsole.log(currentRBG, desiredRDG)
\t\t\tvar days =\"\";
\t\t\tvar hours =\"\";
\t\t\tvar deltaTimes;
\t\t\tvar deltaTimes1;
