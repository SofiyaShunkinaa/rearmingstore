...
class __TwigTemplate_227ecc23403ea8b4c5394adf1c42f654 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t
\t\t\t\$('#comlete-time-text').attr('data-hours', extra_hours);
\t\t\t\$('#comlete-time-text').attr('data-minutes', extra_minutes);
