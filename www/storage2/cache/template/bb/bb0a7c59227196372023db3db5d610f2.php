...
class __TwigTemplate_c491c6325dadcf48ed032c0cdf09e8aa extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t";
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 163) == "select")) {
                    // line 164
                    echo "\t\t\t\t\t  <div class=\"row\" ";
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 164) == "Original Price")) {
...
\t\t\t\t\t\t\t<div>";
                    ...
                    echo " ";
                    echo twig_get_attribute($this->env, $this->source, ($context["option_value"] ?? null), "name", [], "any", false, false, false, 167);
                    echo "</div>
\t\t\t\t\t\t\t<input name=\"option[";
                    // line 168
