...
class __TwigTemplate_a9a0ac9a5e1b4c53fffb63b1c4d84b66 extends Template
{
    private $source;
    private $macros = [];
...
\t\tlet extra = \$('#comlete-time-text').attr('data-extra-days') == \"\" ?  0 : parseInt(\$('#comlete-time-text').attr('data-extra-days'));
\t\tif(rating == \"2300\"){
\t\t\tdays--;
\t\t}
\t\tdays +=extra;
