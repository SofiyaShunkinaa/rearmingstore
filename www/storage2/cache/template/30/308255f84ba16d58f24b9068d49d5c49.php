...
class __TwigTemplate_2ace007e1d996332fd344536b560827e extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tconsole.log(\"Sign: \",\$(this).attr('data-prefix'))
