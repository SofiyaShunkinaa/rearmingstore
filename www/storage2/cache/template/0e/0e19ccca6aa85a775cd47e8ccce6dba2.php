...
class __TwigTemplate_34f32cc55ca79b15409df348f3c2dc66 extends Template
{
    private $source;
    private $macros = [];
...
\t\$(document).ready(function() {
\t\tconsole.log(\"fun not on click\")

\t\tvar initialOption = \$('.dropdown-item.selected').data('name'); 
\t\tif (initialOption) {
\t\tupdateInfoText(initialOption);
\t\t}
\t});
</script>
