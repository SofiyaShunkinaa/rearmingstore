...
class __TwigTemplate_b83799541ceac6aad6d27048f44f00c8 extends Template
{
    private $source;
    private $macros = [];
...
\t}
\t
\tfunction calcTimeByRatingSubstraction(current = \$('.dropdown-item[data-name=\"Current RBG rating\"]').first().data('value').split('-')[1],
\t\t\t\t\t\t\t\t\t\t\tdesired = \$('.dropdown-item[data-name=\"Current RBG rating\"]').first().data){
