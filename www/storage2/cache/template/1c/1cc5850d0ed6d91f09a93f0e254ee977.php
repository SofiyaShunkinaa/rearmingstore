...
class __TwigTemplate_9b446f5c6c1f000a713afdc1194823c8 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tlet currentR = \$('.dropdown-item[data-name=\"current Level\"]').data('value');
\t\t\tlet desiredR = \$('.dropdown-item[data-name=\"Desired level\"]').data('value');
\t\t}
\t\telse{
