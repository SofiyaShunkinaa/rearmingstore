...
class __TwigTemplate_5bd16ae4ef7b7715d7405097034d56b4 extends Template
{
    private $source;
    private $macros = [];
...
document.addEventListener(\"DOMContentLoaded\", function() {
    function hideRowIfOriginalPrice() {
        document.querySelectorAll('.row').forEach(function(row) {
            const originalPriceItem = row.querySelector('.dropdown-item[data-value=\"Original Price\"]');
    ...
    // Скрываем блоки сразу после загрузки страницы
