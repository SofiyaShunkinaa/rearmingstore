...
class __TwigTemplate_8aec5a1e8d73e5315be81d5d16303cd9 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t";
                        // line 204
                        if (((((((((((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 204) == "Boost Method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 204) == "Piloted")) || ((twig_get_attribute($this->env, $this->source,                         // line 205
$context["option"], "name", [], "any", false, false, false, 205) == "Boost method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 205) == "Piloted (Solo Shuffle)"))) || ((twig_get_attribute($this->env, $this->source,                         // line 206
$context["option"], "name", [], "any", false, false, false, 206) == "Execution options") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 206) == "Full Gear"))) || ((twig_get_attribute($this->env, $this->source,                         // line 207
$context["option"], "name", [], "any", false, false, false, 207) == "EXECUTION OPTIONS") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 207) == "Keystone Hero"))) || ((twig_get_attribute($this->env, $this->source,                         // line 208
$context["option"], "name", [], "any", false, false, false, 208) == "ARENA BRACKET") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 208) == "2v2 Arena"))) || ((twig_get_attribute($this->env, $this->source,                         // line 209
$context["option"], "name", [], "any", false, false, false, 209) == "COACH EXPERIENCE") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 209) == "Multi-Gladiator"))) || ((twig_get_attribute($this->env, $this->source,                         // line 210
$context["option"], "name", [], "any", false, false, false, 210) == "Execution Speed") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 210) == "Regular"))) || ((twig_get_attribute($this->env, $this->source,                         // line 211
$context["option"], "name", [], "any", false, false, false, 211) == "Boost Method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 211) == "Selfplay"))) || ((twig_get_attribute($this->env, $this->source,                         // line 212
$context["option"], "name", [], "any", false, false, false, 212) == "Basic option") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 212) == "70-80 Leveling + 8/8 M+0 Dungeons + 593 ilvl Gear")))) {
                            echo "checked";
                        }
                        echo "/>
\t\t\t\t\t\t\t\t\t\t
...
\t\t\t\t\t";
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 228) == "checkbox")) {
                    // line 229
                    echo "\t\t\t\t\t\t<div class=\"opt-checkbox\" ";
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 229) == "Select Dungeons")) {
                        echo "id=\"hidden-options-checkbox\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 229) == "Specific Slot")) {
                        echo "id=\"specific-gear-slot\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 229) == "Specific Item Slot")) {
...
\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" ";
                        // line 234
                        if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 234), [0 => "Select Dungeons", 1 => "Speecific Item Slot", 2 => "Specific Slot"])) {
...
\t\t\t\t\t";
                ...
                // line 258
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 258) == "file")) {
                    // line 259
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t";
                ...
                // line 276
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 276) == "datetime")) {
                    // line 277
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t";
                ...
                // line 298
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 298) == "choice")) {
                    // line 299
                    echo "\t\t\t\t\t  <div class=\"row\">
\t\t\t\t\t\t<div class=\"col-md-12\">
...
function calcPrice() {
    ...
    // Получаем начальное значение из атрибута data-prise элемента input[type=\"hidden\"]
    var initialPrice = \$('#product input[type=\"hidden\"][data-prise]').first().attr('data-prise');
    all_price += getNum(initialPrice); // Увеличиваем all_price на начальное значение

    // Считаем сумму для выбранных радио-инпутов
    ...
    // Считаем сумму для отмеченных чекбоксов
    ...
    // Считаем сумму для hidden-инпутов
    ...
    // Учитываем значение из слайдера
    var sliderValue = \$(\"#slider\").data(\"ionRangeSlider\").result.from; // Получаем текущее значение слайдера
    var sliderMultiplier = getNum(\$('#product input[type=\"hidden\"][data-prise]').first().attr('data-prise')); // Получаем data-prise из hidden
    all_price += sliderValue * sliderMultiplier; // Умножаем значение слайдера на data-prise и добавляем к общей цене

    // Умножаем на количество, если оно указано
...
";
    ...
    {
        return array (  4118 => 3596,  1259 => 740,  1252 => 736,  1168 => 655,  1159 => 649,  1151 => 644,  900 => 396,  896 => 395,  892 => 394,  872 => 377,  865 => 373,  857 => 368,  831 => 345,  824 => 341,  820 => 340,  817 => 339,  807 => 333,  802 => 331,  798 => 330,  790 => 325,  786 => 324,  780 => 321,  775 => 318,  772 => 317,  769 => 316,  763 => 315,  758 => 313,  742 => 299,  739 => 298,  725 => 291,  718 => 289,  711 => 288,  708 => 287,  694 => 280,  687 => 278,  680 => 277,  677 => 276,  663 => 269,  656 => 267,  649 => 266,  646 => 265,  638 => 262,  630 => 261,  626 => 260,  619 => 259,  616 => 258,  604 => 255,  598 => 254,  591 => 253,  588 => 252,  576 => 249,  570 => 248,  563 => 247,  560 => 246,  556 => 244,  547 => 240,  540 => 238,  538 => 237,  534 => 236,  528 => 235,  510 => 234,  506 => 232,  502 => 231,  498 => 230,  485 => 229,  483 => 228,  478 => 225,  474 => 223,  465 => 219,  458 => 217,  456 => 216,  452 => 215,  446 => 214,  439 => 212,  438 => 211,  437 => 210,  436 => 209,  435 => 208,  434 => 207,  433 => 206,  432 => 205,  431 => 204,  427 => 203,  423 => 202,  417 => 201,  413 => 200,  409 => 199,  404 => 196,  400 => 195,  396 => 194,  393 => 193,  390 => 192,  381 => 185,  372 => 181,  362 => 179,  360 => 178,  356 => 177,  344 => 176,  341 => 175,  337 => 174,  333 => 173,  319 => 168,  315 => 167,  311 => 166,  307 => 164,  305 => 163,  300 => 162,  295 => 161,  293 => 160,  286 => 155,  283 => 154,  270 => 152,  265 => 151,  263 => 150,  255 => 145,  248 => 141,  242 => 137,  232 => 135,  229 => 134,  219 => 132,  217 => 131,  210 => 126,  206 => 124,  195 => 122,  191 => 121,  188 => 120,  186 => 119,  170 => 106,  164 => 102,  158 => 101,  152 => 99,  144 => 97,  141 => 96,  137 => 95,  130 => 91,  37 => 1,);
    }
