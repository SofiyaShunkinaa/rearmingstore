...
class __TwigTemplate_687b8bc76b12e1c4259c3a53fbaf7b20 extends Template
{
    private $source;
    private $macros = [];
...
#slider{
\tlinear-gradient(to right, #4caf50 0%, #4caf50 calc((100% - var(--slider-range-start)) * 1%), #ccc 0%);
}
</style>
