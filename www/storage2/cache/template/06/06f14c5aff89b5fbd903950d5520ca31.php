...
class __TwigTemplate_008a03dd792ff1c03004d2e3ce953807 extends Template
{
    private $source;
    private $macros = [];
...
\t\tconsole.log(bool(\$('#comlete-time-text').attr('data-days')))
\t\tlet [days, hours] = getDaysAndHours();
\t\tlet additional = 0;
...
\t\tlet additional_days = \$('#comlete-time-text').attr('data-hours');
