...
class __TwigTemplate_1250e84695ff859ed93705642c4f15f5 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tlet days = \$('#comlete-time-text').attr('data-current-val') ? \"\" : \$('#comlete-time-text').attr('data-current-val');
\t\t\t
\t\t\tif(count==2){
\t\t\t\tdays+=65
