...
class __TwigTemplate_9eaea8bc1506db2cec551b15ef252dfc extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t
\t\t\t\t\t\t\t<label for=\"slider\">Текущее значение: <span id=\"sliderValue\">50</span></label>
\t\t\t\t\t\t\t<input type=\"range\" 
\t\t\t\t\t\t\t\tmin=\"";
        // line 272
