...
class __TwigTemplate_e6afdb3ac1b5b89a5a9337aa2f6bbf25 extends Template
{
    private $source;
    private $macros = [];
...
<script type=\"text/javascript\">
\tconsole.log(\$('#info-text').text(\"3 hours order completion\"));
