...
class __TwigTemplate_62de73a23c33ac3c450d94a696645207 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
        ...
        if (($context["options"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
                // line 162
                echo "\t\t\t\t  ";
                echo twig_get_attribute($this->env, $this->source, ($context["option_value"] ?? null), "name", [], "any", false, false, false, 162);
                echo "
\t\t\t\t  <h3>";
                // line 163
                echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["option"], "product_option_value", [], "any", false, false, false, 163), "name", [], "any", false, false, false, 163);
                echo "</h3>
\t\t\t\t\t";
                // line 164
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 164) == "select")) {
                    // line 165
                    echo "\t\t\t\t\t  <div class=\"row\" ";
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 165) == "Original Price")) {
                        echo " id=\"original-price\" ";
                    }
                    echo ">
\t\t\t\t\t\t<div class=\"col-md-12\">
\t\t\t\t\t\t  <div class=\"borderedRow borderedRow-";
                    // line 167
                    echo twig_get_attribute($this->env, $this->source, $context["option"], "id", [], "any", false, false, false, 167);
                    echo "\">
\t\t\t\t\t\t\t<div>";
                    // line 168
...
\t\t\t\t\t\t\t<input name=\"option[";
                    ...
                    echo twig_get_attribute($this->env, $this->source, ($context["option_value"] ?? null), "name", [], "any", false, false, false, 169);
                    echo "\" data-value=\"";
                    echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["option"], "product_option_value", [], "any", false, false, false, 169), "name", [], "any", false, false, false, 169);
                    echo "\">
...
\t\t\t\t\t";
                ...
                // line 193
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 193) == "radio")) {
                    // line 194
...
\t\t\t\t\t\t\t\t\t\t\t";
                        // line 205
                        if (((((((((((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 205) == "Boost Method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 205) == "Piloted")) || ((twig_get_attribute($this->env, $this->source,                         // line 206
$context["option"], "name", [], "any", false, false, false, 206) == "Boost method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 206) == "Piloted (Solo Shuffle)"))) || ((twig_get_attribute($this->env, $this->source,                         // line 207
$context["option"], "name", [], "any", false, false, false, 207) == "Execution options") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 207) == "Full Gear"))) || ((twig_get_attribute($this->env, $this->source,                         // line 208
$context["option"], "name", [], "any", false, false, false, 208) == "EXECUTION OPTIONS") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 208) == "Keystone Hero"))) || ((twig_get_attribute($this->env, $this->source,                         // line 209
$context["option"], "name", [], "any", false, false, false, 209) == "ARENA BRACKET") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 209) == "2v2 Arena"))) || ((twig_get_attribute($this->env, $this->source,                         // line 210
$context["option"], "name", [], "any", false, false, false, 210) == "COACH EXPERIENCE") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 210) == "Multi-Gladiator"))) || ((twig_get_attribute($this->env, $this->source,                         // line 211
$context["option"], "name", [], "any", false, false, false, 211) == "Execution Speed") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 211) == "Regular"))) || ((twig_get_attribute($this->env, $this->source,                         // line 212
$context["option"], "name", [], "any", false, false, false, 212) == "Boost Method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 212) == "Selfplay"))) || ((twig_get_attribute($this->env, $this->source,                         // line 213
$context["option"], "name", [], "any", false, false, false, 213) == "Basic option") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 213) == "70-80 Leveling + 8/8 M+0 Dungeons + 593 ilvl Gear")))) {
                            echo "checked";
                        }
                        echo "/>
\t\t\t\t\t\t\t\t\t\t
...
\t\t\t\t\t";
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 229) == "checkbox")) {
                    // line 230
                    echo "\t\t\t\t\t\t<div class=\"opt-checkbox\" ";
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 230) == "Select Dungeons")) {
                        echo "id=\"hidden-options-checkbox\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 230) == "Specific Slot")) {
                        echo "id=\"specific-gear-slot\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 230) == "Specific Item Slot")) {
...
\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" ";
                        // line 235
                        if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 235), [0 => "Select Dungeons", 1 => "Speecific Item Slot", 2 => "Specific Slot"])) {
...
\t\t\t\t\t";
                ...
                // line 266
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 266) == "date")) {
                    // line 267
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t";
                ...
                // line 288
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 288) == "time")) {
                    // line 289
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t";
                ...
                // line 299
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 299) == "choice")) {
                    // line 300
                    echo "\t\t\t\t\t  <div class=\"row\">
\t\t\t\t\t\t<div class=\"col-md-12\">
...
\t\t\tconsole.log(\"Sign: \",\$(this).attr('data-prisePref'))
...
";
    ...
    {
        return array (  4126 => 3597,  1267 => 741,  1260 => 737,  1176 => 656,  1167 => 650,  1159 => 645,  908 => 397,  904 => 396,  900 => 395,  880 => 378,  873 => 374,  865 => 369,  839 => 346,  832 => 342,  828 => 341,  825 => 340,  815 => 334,  810 => 332,  806 => 331,  798 => 326,  794 => 325,  788 => 322,  783 => 319,  780 => 318,  777 => 317,  771 => 316,  766 => 314,  750 => 300,  747 => 299,  733 => 292,  726 => 290,  719 => 289,  716 => 288,  702 => 281,  695 => 279,  688 => 278,  685 => 277,  671 => 270,  664 => 268,  657 => 267,  654 => 266,  646 => 263,  638 => 262,  634 => 261,  627 => 260,  624 => 259,  612 => 256,  606 => 255,  599 => 254,  596 => 253,  584 => 250,  578 => 249,  571 => 248,  568 => 247,  564 => 245,  555 => 241,  548 => 239,  546 => 238,  542 => 237,  536 => 236,  518 => 235,  514 => 233,  510 => 232,  506 => 231,  493 => 230,  491 => 229,  486 => 226,  482 => 224,  473 => 220,  466 => 218,  464 => 217,  460 => 216,  454 => 215,  447 => 213,  446 => 212,  445 => 211,  444 => 210,  443 => 209,  442 => 208,  441 => 207,  440 => 206,  439 => 205,  435 => 204,  431 => 203,  425 => 202,  421 => 201,  417 => 200,  412 => 197,  408 => 196,  404 => 195,  401 => 194,  398 => 193,  389 => 186,  380 => 182,  370 => 180,  368 => 179,  364 => 178,  352 => 177,  349 => 176,  345 => 175,  341 => 174,  327 => 169,  323 => 168,  319 => 167,  311 => 165,  309 => 164,  305 => 163,  300 => 162,  295 => 161,  293 => 160,  286 => 155,  283 => 154,  270 => 152,  265 => 151,  263 => 150,  255 => 145,  248 => 141,  242 => 137,  232 => 135,  229 => 134,  219 => 132,  217 => 131,  210 => 126,  206 => 124,  195 => 122,  191 => 121,  188 => 120,  186 => 119,  170 => 106,  164 => 102,  158 => 101,  152 => 99,  144 => 97,  141 => 96,  137 => 95,  130 => 91,  37 => 1,);
    }
