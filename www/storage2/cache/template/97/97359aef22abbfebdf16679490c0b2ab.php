...
class __TwigTemplate_0a081d871f681abc691d800a2d4979f9 extends Template
{
    private $source;
    private $macros = [];
...
\t\t{
\t\t\t\$('#comlete-time-text').text(((additionalMonths+\" months \")+days == 0 ? \"\" : (days == 1 ? days + \" day \" : (days + \" days \")))+ \" order completion\");
\t\t}else{
