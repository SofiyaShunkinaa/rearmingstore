...
class __TwigTemplate_7b48677720e2c62175131ca46673261b extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tlet days = \$('#comlete-time-text').attr('data-current-val')
\t\t\tif(count==2){
\t\t\t\tdays+=65
