...
class __TwigTemplate_5a1bc9c65dce6591dfc0eb6eb5629947 extends Template
{
    private $source;
    private $macros = [];
...
\t\t{
\t\t\t\$('#comlete-time-text').text(((additionalMonths+\" months \")+ Number(days) == 0 ? \"\" : (Number(days) == 1 ? days + \" day \" : (days + \" days \")) )+ \" order completion\");
\t\t}else{
