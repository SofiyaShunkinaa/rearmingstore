...
class __TwigTemplate_bf80d02763cc79bd1a6667f45768d1ba extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tevent.preventDefault(); 
\t\t\tcurrentR = \$('.dropdown-item[data-name=\"Current rating\"]').first().data('value');
\t\t
