...
class __TwigTemplate_dfdcb8efcf603daafaa59bbab7e4c8e8 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["breadcrumb"]) {
            // line 93
            echo "\t\t\t\t\t";
            if (twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "href", [], "any", false, false, false, 93)) {
                // line 94
                echo "\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "href", [], "any", false, false, false, 94);
                echo "\"  class=\"breadcrumb-item\">";
                echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "text", [], "any", false, false, false, 94);
                echo "</a>
\t\t\t\t\t";
            } else {
                // line 96
                echo "\t\t\t\t\t\t<span class=\"breadcrumb-item active\">";
                echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "text", [], "any", false, false, false, 96);
                echo "</span>
\t\t\t\t\t";
            }
            // line 98
...
\t\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["prod_cat"]) {
                // line 119
                echo "\t\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["prod_cat"], "href", [], "any", false, false, false, 119);
                echo "\" class=\"btn btn-outline-primary form-check-label\">";
                echo twig_get_attribute($this->env, $this->source, $context["prod_cat"], "text", [], "any", false, false, false, 119);
                echo "</a>
\t\t\t\t\t\t";
            }
            $_parent = $context['_parent'];
...
\t\t\t\t\t\t";
        ...
        if (($context["tags_prod"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["tag_prod"]) {
                // line 149
                echo "\t\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "href", [], "any", false, false, false, 149);
                echo "\" class=\"btn btn-outline-primary form-check-label ";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "active", [], "any", false, false, false, 149);
                echo "\">";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "tag", [], "any", false, false, false, 149);
                echo "</a>
\t\t\t\t\t\t\t";
            }
            $_parent = $context['_parent'];
...
\t\t\t\t";
        ...
        if (($context["options"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
                // line 159
                echo "\t\t\t\t  <h3>";
                echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["option"], "product_option_value", [], "any", false, false, false, 159), "name", [], "any", false, false, false, 159);
                echo "</h3>
\t\t\t\t\t";
                // line 160
...
\t\t\t\t\t\t  <div class=\"borderedRow borderedRow-";
                    // line 163
                    echo twig_get_attribute($this->env, $this->source, $context["option"], "id", [], "any", false, false, false, 163);
                    echo "\">
\t\t\t\t\t\t\t<div>";
                    // line 164
...
\t\t\t\t\t\t\t<input name=\"option[";
                    ...
                    echo twig_get_attribute($this->env, $this->source, ($context["option_value"] ?? null), "name", [], "any", false, false, false, 165);
                    echo "\" data-value=\"";
                    echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["option"], "product_option_value", [], "any", false, false, false, 165), "name", [], "any", false, false, false, 165);
                    echo "\">
...
\t\t\t\t\t";
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 206) == "checkbox")) {
                    // line 207
                    echo "\t\t\t\t\t\t<div class=\"opt-checkbox\" ";
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 207) == "Select Dungeons")) {
                        echo "id=\"hidden-options-checkbox\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 207) == "Specific Slot")) {
                        echo "id=\"specific-gear-slot\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 207) == "Specific Item Slot")) {
...
\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" ";
                        // line 212
                        if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 212), [0 => "Select Dungeons", 1 => "Speecific Item Slot", 2 => "Specific Slot"])) {
...
\t\t\t\t\t";
                ...
                // line 265
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 265) == "time")) {
                    // line 266
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t";
                ...
                // line 276
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 276) == "choice")) {
                    // line 277
                    echo "\t\t\t\t\t  <div class=\"row\">
\t\t\t\t\t\t<div class=\"col-md-12\">
...
\$(document).ready(function () {
    ...
    if (\$('#slider').length > 0) {
        ...
        // Проверяем, есть ли корректные значения для min и max
        if (typeof minSliderValue === 'number' && typeof maxSliderValue === 'number') {
            ...
            console.error(\"Неверные значения для слайдера: min или max не являются числами.\");
        }
        ...
        console.log(\"Слайдер не найден на странице.\"); // или другая логика, если слайдера нет
    }
});
...
";
    ...
    {
        return array (  3949 => 3443,  2376 => 1873,  2372 => 1872,  1116 => 619,  1109 => 615,  1025 => 534,  1016 => 528,  1008 => 523,  836 => 354,  829 => 350,  822 => 346,  796 => 323,  789 => 319,  785 => 318,  782 => 317,  772 => 311,  767 => 309,  763 => 308,  755 => 303,  751 => 302,  745 => 299,  740 => 296,  737 => 295,  734 => 294,  728 => 293,  723 => 291,  707 => 277,  704 => 276,  690 => 269,  683 => 267,  676 => 266,  673 => 265,  659 => 258,  652 => 256,  645 => 255,  642 => 254,  628 => 247,  621 => 245,  614 => 244,  611 => 243,  603 => 240,  595 => 239,  591 => 238,  584 => 237,  581 => 236,  569 => 233,  563 => 232,  556 => 231,  553 => 230,  541 => 227,  535 => 226,  528 => 225,  525 => 224,  521 => 222,  512 => 218,  505 => 216,  503 => 215,  499 => 214,  493 => 213,  475 => 212,  471 => 210,  467 => 209,  463 => 208,  450 => 207,  447 => 206,  443 => 204,  434 => 200,  427 => 198,  425 => 197,  421 => 196,  415 => 195,  401 => 194,  397 => 192,  393 => 191,  389 => 190,  386 => 189,  383 => 188,  374 => 181,  366 => 178,  359 => 176,  357 => 175,  353 => 174,  341 => 173,  338 => 172,  334 => 171,  330 => 170,  316 => 165,  312 => 164,  308 => 163,  304 => 161,  302 => 160,  297 => 159,  292 => 158,  290 => 157,  283 => 152,  280 => 151,  267 => 149,  262 => 148,  260 => 147,  252 => 142,  245 => 138,  239 => 134,  229 => 132,  226 => 131,  216 => 129,  214 => 128,  207 => 123,  203 => 121,  192 => 119,  188 => 118,  185 => 117,  183 => 116,  167 => 103,  161 => 99,  155 => 98,  149 => 96,  141 => 94,  138 => 93,  134 => 92,  127 => 88,  37 => 1,);
    }
