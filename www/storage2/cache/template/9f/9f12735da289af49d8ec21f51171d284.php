...
class __TwigTemplate_5bf2a1da67ce3fe965254df3d332929c extends Template
{
    private $source;
    private $macros = [];
...
\t\tvar optionName = \$(this).next('label').text(); 
