...
class __TwigTemplate_4924c0e4c547367b36da613e21984ff6 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\$('#product .total span.price-value').text(updated);
