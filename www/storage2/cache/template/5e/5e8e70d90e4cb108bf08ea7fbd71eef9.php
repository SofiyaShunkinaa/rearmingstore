...
class __TwigTemplate_24c4316afc29e9369d81dadbdfaf8aed extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tconsole.log(\"days:  \"+extraDays+\"hours:  \"+hours+\"extraMinutes: \"+minutes);
\t\t\tdays +=  Math.floor(hours / 24)+extraDays + hours/24;
\t\t\thours =  hours % 24;
\t\t\tconsole.log(days)
\t\t\tif(hours>=12 && days>0){
\t\t\t\tdays++;
