...
class __TwigTemplate_a478ee3ee4fb431c4ca2fe268cafb24a extends Template
{
    private $source;
    private $macros = [];
...
\t\tvar current = \$('.dropdown-item[data-name=\"Current RBG rating\"].active').first().data('value').split('-')[1]
\t\tvar desired = \$('.dropdown-item[data-name=\"Desired RBG rating\"].active').data('value')
...
\t\t\t\t
\t\t\t\t    let n = \$('.dropdown-item[data-name=\"Desired RBG rating\"]').data('value');
\t\t\t\t\tconsole.log(n);
