...
class __TwigTemplate_d1b67877d64f4363ffcb4a058a50d6dc extends Template
{
    private $source;
    private $macros = [];
...
#slider{
\tbackground: linear-gradient(to right, #4caf50 0%, #4caf50 calc((100% - var(--slider-range-start)) * 1%), #ccc 0%);
}
</style>
...
\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["breadcrumb"]) {
            // line 71
            echo "\t\t\t\t\t";
            if (twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "href", [], "any", false, false, false, 71)) {
                // line 72
                echo "\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "href", [], "any", false, false, false, 72);
                echo "\"  class=\"breadcrumb-item\">";
                echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "text", [], "any", false, false, false, 72);
                echo "</a>
\t\t\t\t\t";
            } else {
                // line 74
...
\t\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["prod_cat"]) {
                // line 97
                echo "\t\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["prod_cat"], "href", [], "any", false, false, false, 97);
                echo "\" class=\"btn btn-outline-primary form-check-label\">";
                echo twig_get_attribute($this->env, $this->source, $context["prod_cat"], "text", [], "any", false, false, false, 97);
                echo "</a>
\t\t\t\t\t\t";
            }
            $_parent = $context['_parent'];
...
\t\t\t\t\t\t";
        ...
        if (($context["tags_prod"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["tag_prod"]) {
                // line 127
                echo "\t\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "href", [], "any", false, false, false, 127);
                echo "\" class=\"btn btn-outline-primary form-check-label ";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "active", [], "any", false, false, false, 127);
                echo "\">";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "tag", [], "any", false, false, false, 127);
                echo "</a>
\t\t\t\t\t\t\t";
            }
            $_parent = $context['_parent'];
...
\t\t\t\t";
        ...
        if (($context["options"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
                // line 137
                echo "\t\t\t\t  <h3>";
                echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["option"], "product_option_value", [], "any", false, false, false, 137), "name", [], "any", false, false, false, 137);
                echo "</h3>
\t\t\t\t\t";
                // line 138
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 138) == "select")) {
                    // line 139
                    echo "\t\t\t\t\t  <div class=\"row\">
\t\t\t\t\t\t<div class=\"col-md-12\">
\t\t\t\t\t\t  <div class=\"borderedRow borderedRow-";
                    // line 141
                    echo twig_get_attribute($this->env, $this->source, $context["option"], "id", [], "any", false, false, false, 141);
                    echo "\">
\t\t\t\t\t\t\t<div>";
                    // line 142
...
\t\t\t\t\t\t\t<input name=\"option[";
                    ...
                    echo twig_get_attribute($this->env, $this->source, ($context["option_value"] ?? null), "name", [], "any", false, false, false, 143);
                    echo "\" data-value=\"";
                    echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["option"], "product_option_value", [], "any", false, false, false, 143), "name", [], "any", false, false, false, 143);
                    echo "\">
...
\t\t\t\t\t";
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 184) == "checkbox")) {
                    // line 185
                    echo "\t\t\t\t\t\t<div class=\"opt-checkbox\" ";
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 185) == "Select Dungeons")) {
                        echo "id=\"hidden-options-checkbox\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 185) == "Specific Slot")) {
                        echo "id=\"specific-gear-slot\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 185) == "Specific Item Slot")) {
...
\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" ";
                        // line 190
                        if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 190), [0 => "Select Dungeons", 1 => "Speecific Item Slot", 2 => "Specific Slot"])) {
...
\t\t\t\t\t";
                ...
                // line 254
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 254) == "choice")) {
                    // line 255
                    echo "\t\t\t\t\t  <div class=\"row\">
\t\t\t\t\t\t<div class=\"col-md-12\">
...
";
    ...
    {
        return array (  3896 => 3396,  1094 => 597,  1087 => 593,  1003 => 512,  994 => 506,  986 => 501,  814 => 332,  807 => 328,  800 => 324,  774 => 301,  767 => 297,  763 => 296,  760 => 295,  750 => 289,  745 => 287,  741 => 286,  733 => 281,  729 => 280,  723 => 277,  718 => 274,  715 => 273,  712 => 272,  706 => 271,  701 => 269,  685 => 255,  682 => 254,  668 => 247,  661 => 245,  654 => 244,  651 => 243,  637 => 236,  630 => 234,  623 => 233,  620 => 232,  606 => 225,  599 => 223,  592 => 222,  589 => 221,  581 => 218,  573 => 217,  569 => 216,  562 => 215,  559 => 214,  547 => 211,  541 => 210,  534 => 209,  531 => 208,  519 => 205,  513 => 204,  506 => 203,  503 => 202,  499 => 200,  490 => 196,  483 => 194,  481 => 193,  477 => 192,  471 => 191,  453 => 190,  449 => 188,  445 => 187,  441 => 186,  428 => 185,  425 => 184,  421 => 182,  412 => 178,  405 => 176,  403 => 175,  399 => 174,  393 => 173,  379 => 172,  375 => 170,  371 => 169,  367 => 168,  364 => 167,  361 => 166,  352 => 159,  344 => 156,  337 => 154,  335 => 153,  331 => 152,  319 => 151,  316 => 150,  312 => 149,  308 => 148,  294 => 143,  290 => 142,  286 => 141,  282 => 139,  280 => 138,  275 => 137,  270 => 136,  268 => 135,  261 => 130,  258 => 129,  245 => 127,  240 => 126,  238 => 125,  230 => 120,  223 => 116,  217 => 112,  207 => 110,  204 => 109,  194 => 107,  192 => 106,  185 => 101,  181 => 99,  170 => 97,  166 => 96,  163 => 95,  161 => 94,  145 => 81,  139 => 77,  133 => 76,  127 => 74,  119 => 72,  116 => 71,  112 => 70,  105 => 66,  37 => 1,);
    }
