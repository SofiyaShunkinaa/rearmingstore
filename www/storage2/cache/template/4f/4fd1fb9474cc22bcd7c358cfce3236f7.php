...
class __TwigTemplate_cfcb073ad8ee122036aaee67d45d7d12 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\tif((days != 1 && hours != 14)||(days!=0&&hours!=16)){
\t\t\t\t\tdays++;
\t\t\t\t\thours = 0;
\t\t\t\t}
