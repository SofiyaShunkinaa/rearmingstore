...
class __TwigTemplate_589046868c4b87ab3001bd6901579d13 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\$('#comlete-time-text').attr('data-days', days-=additionals);
\t\t
\t\tconsole.log(\"additionals: \"+ additionals+\"  days: \"+days-=additionals+\" hours: \"+hours)
\t
\t}
\t
