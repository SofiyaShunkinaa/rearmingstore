...
class __TwigTemplate_98c626953db8f98a8119a2fb0cd0b3d1 extends Template
{
    private $source;
    private $macros = [];
...
\t\tconsole.log(\"items: \",getSelectedRadioOptionName())
