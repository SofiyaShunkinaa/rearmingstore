...
class __TwigTemplate_7d68dc97949b220f52d6c83cb746f75c extends Template
{
    private $source;
    private $macros = [];
...
\tconsole.log(getNum(initialPrice))
    ...
    console.log(parseFloat(all_price).toFixed(2)-parseFloat(getNum(initialPrice)*0.01).toFixed(2))
