...
class __TwigTemplate_c1a418eaae27f2d3bd2c74e552b10998 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\"Conquest Gear Boost\", \"Wrathion Reputation Boost\", \"Conquest Gear Boost\", \"Soridormi Reputation Boost\"].includes(productName):
...
\t\t\tcurrentR = \$('.dropdown-item[data-name=\"Your current 3v3 rating').data('value') == \"0-1500\" ? 1500 : \$('.dropdown-item[data-name=\"Your current 3v3 rating').data('value');
\t\t\tconsole.log(\"3v3 rating:  \", currentR)
\t\t}else {
\t\t\t
