...
class __TwigTemplate_b69bb12de867363da609017c881076eb extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tlet additional_days = \$('#comlete-time-text').attr('data-hours') == \"\" ? \"\" : \$('#comlete-time-text').attr('data-hours');
