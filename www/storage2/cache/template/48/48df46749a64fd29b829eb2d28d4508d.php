...
class __TwigTemplate_b877b4a2a6d5a41f86e15f256337b27f extends Template
{
    private $source;
    private $macros = [];
...
.tab-content p a, .tab-content p u{
...
\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["breadcrumb"]) {
            // line 113
            echo "\t\t\t\t\t";
            if (twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "href", [], "any", false, false, false, 113)) {
                // line 114
                echo "\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "href", [], "any", false, false, false, 114);
                echo "\"  class=\"breadcrumb-item\">";
                echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "text", [], "any", false, false, false, 114);
                echo "</a>
\t\t\t\t\t";
            } else {
                // line 116
...
\t\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["prod_cat"]) {
                // line 139
                echo "\t\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["prod_cat"], "href", [], "any", false, false, false, 139);
                echo "\" class=\"btn btn-outline-primary form-check-label\">";
                echo twig_get_attribute($this->env, $this->source, $context["prod_cat"], "text", [], "any", false, false, false, 139);
                echo "</a>
\t\t\t\t\t\t";
            }
            $_parent = $context['_parent'];
...
\t\t\t\t\t\t";
        ...
        if (($context["tags_prod"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["tag_prod"]) {
                // line 169
                echo "\t\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "href", [], "any", false, false, false, 169);
                echo "\" class=\"btn btn-outline-primary form-check-label ";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "active", [], "any", false, false, false, 169);
                echo "\">";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "tag", [], "any", false, false, false, 169);
                echo "</a>
\t\t\t\t\t\t\t";
            }
            $_parent = $context['_parent'];
...
\t\t\t\t";
        ...
        if (($context["options"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
                // line 179
                echo "\t\t\t\t  <h3>";
                echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["option"], "product_option_value", [], "any", false, false, false, 179), "name", [], "any", false, false, false, 179);
                echo "</h3>
\t\t\t\t\t";
                // line 180
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 180) == "select")) {
                    // line 181
                    echo "\t\t\t\t\t  <div class=\"row\">
\t\t\t\t\t\t<div class=\"col-md-12\">
\t\t\t\t\t\t  <div class=\"borderedRow borderedRow-";
                    // line 183
                    echo twig_get_attribute($this->env, $this->source, $context["option"], "id", [], "any", false, false, false, 183);
                    echo "\">
\t\t\t\t\t\t\t<div>";
                    // line 184
...
\t\t\t\t\t\t\t<input name=\"option[";
                    ...
                    echo twig_get_attribute($this->env, $this->source, ($context["option_value"] ?? null), "name", [], "any", false, false, false, 185);
                    echo "\" data-value=\"";
                    echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["option"], "product_option_value", [], "any", false, false, false, 185), "name", [], "any", false, false, false, 185);
                    echo "\">
...
\t\t\t\t\t\t\t\t\t\t\t";
                        // line 221
                        if (((((((((((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 221) == "Boost Method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 221) == "Piloted")) || ((twig_get_attribute($this->env, $this->source,                         // line 222
$context["option"], "name", [], "any", false, false, false, 222) == "Boost method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 222) == "Piloted (Solo Shuffle)"))) || ((twig_get_attribute($this->env, $this->source,                         // line 223
$context["option"], "name", [], "any", false, false, false, 223) == "Execution options") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 223) == "Full Gear"))) || ((twig_get_attribute($this->env, $this->source,                         // line 224
$context["option"], "name", [], "any", false, false, false, 224) == "EXECUTION OPTIONS") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 224) == "Keystone Hero"))) || ((twig_get_attribute($this->env, $this->source,                         // line 225
$context["option"], "name", [], "any", false, false, false, 225) == "ARENA BRACKET") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 225) == "2v2 Arena"))) || ((twig_get_attribute($this->env, $this->source,                         // line 226
$context["option"], "name", [], "any", false, false, false, 226) == "COACH EXPERIENCE") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 226) == "Multi-Gladiator"))) || ((twig_get_attribute($this->env, $this->source,                         // line 227
$context["option"], "name", [], "any", false, false, false, 227) == "Execution Speed") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 227) == "Regular"))) || ((twig_get_attribute($this->env, $this->source,                         // line 228
$context["option"], "name", [], "any", false, false, false, 228) == "Boost Method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 228) == "Selfplay"))) || ((twig_get_attribute($this->env, $this->source,                         // line 229
$context["option"], "name", [], "any", false, false, false, 229) == "Basic option") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 229) == "70-80 Leveling + 8/8 M+0 Dungeons + 593 ilvl Gear")))) {
                            echo "checked";
                        }
                        echo "/>
\t\t\t\t\t\t\t\t\t\t
...
\t\t\t\t\t";
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 245) == "checkbox")) {
                    // line 246
                    echo "\t\t\t\t\t\t<div class=\"opt-checkbox\" ";
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 246) == "Select Dungeons")) {
                        echo "id=\"hidden-options-checkbox\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 246) == "Specific Slot")) {
                        echo "id=\"specific-gear-slot\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 246) == "Specific Item Slot")) {
...
\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" ";
                        // line 251
                        if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 251), [0 => "Select Dungeons", 1 => "Speecific Item Slot", 2 => "Specific Slot"])) {
...
\t\t\t\t\t";
                ...
                // line 293
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 293) == "datetime")) {
                    // line 294
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t";
                ...
                // line 304
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 304) == "time")) {
                    // line 305
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t";
                ...
                // line 315
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 315) == "choice")) {
                    // line 316
                    echo "\t\t\t\t\t  <div class=\"row\">
\t\t\t\t\t\t<div class=\"col-md-12\">
...
";
    ...
    {
        return array (  4167 => 3644,  1285 => 765,  1278 => 761,  1194 => 680,  1185 => 674,  1177 => 669,  919 => 414,  915 => 413,  911 => 412,  890 => 394,  883 => 390,  875 => 385,  868 => 380,  850 => 362,  843 => 358,  839 => 357,  836 => 356,  826 => 350,  821 => 348,  817 => 347,  809 => 342,  805 => 341,  799 => 338,  794 => 335,  791 => 334,  788 => 333,  782 => 332,  777 => 330,  761 => 316,  758 => 315,  744 => 308,  737 => 306,  730 => 305,  727 => 304,  713 => 297,  706 => 295,  699 => 294,  696 => 293,  682 => 286,  675 => 284,  668 => 283,  665 => 282,  657 => 279,  649 => 278,  645 => 277,  638 => 276,  635 => 275,  623 => 272,  617 => 271,  610 => 270,  607 => 269,  595 => 266,  589 => 265,  582 => 264,  579 => 263,  575 => 261,  566 => 257,  559 => 255,  557 => 254,  553 => 253,  547 => 252,  529 => 251,  525 => 249,  521 => 248,  517 => 247,  504 => 246,  502 => 245,  497 => 242,  493 => 240,  484 => 236,  477 => 234,  475 => 233,  471 => 232,  465 => 231,  458 => 229,  457 => 228,  456 => 227,  455 => 226,  454 => 225,  453 => 224,  452 => 223,  451 => 222,  450 => 221,  446 => 220,  442 => 219,  436 => 218,  432 => 217,  428 => 216,  423 => 213,  419 => 212,  415 => 211,  412 => 210,  409 => 209,  400 => 202,  391 => 198,  379 => 196,  377 => 195,  373 => 194,  361 => 193,  358 => 192,  354 => 191,  350 => 190,  336 => 185,  332 => 184,  328 => 183,  324 => 181,  322 => 180,  317 => 179,  312 => 178,  310 => 177,  303 => 172,  300 => 171,  287 => 169,  282 => 168,  280 => 167,  272 => 162,  265 => 158,  259 => 154,  249 => 152,  246 => 151,  236 => 149,  234 => 148,  227 => 143,  223 => 141,  212 => 139,  208 => 138,  205 => 137,  203 => 136,  187 => 123,  181 => 119,  175 => 118,  169 => 116,  161 => 114,  158 => 113,  154 => 112,  147 => 108,  37 => 1,);
    }
