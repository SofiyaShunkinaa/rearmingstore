...
class __TwigTemplate_ef894a53f16b6263e2867ba598f71c04 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t";
                        // line 203
                        if (((((((((((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 203) == "Boost Method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 203) == "Piloted")) || ((twig_get_attribute($this->env, $this->source,                         // line 204
$context["option"], "name", [], "any", false, false, false, 204) == "Boost method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 204) == "Piloted (Solo Shuffle)"))) || ((twig_get_attribute($this->env, $this->source,                         // line 205
$context["option"], "name", [], "any", false, false, false, 205) == "Execution options") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 205) == "Full Gear"))) || ((twig_get_attribute($this->env, $this->source,                         // line 206
$context["option"], "name", [], "any", false, false, false, 206) == "EXECUTION OPTIONS") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 206) == "Keystone Hero"))) || ((twig_get_attribute($this->env, $this->source,                         // line 207
$context["option"], "name", [], "any", false, false, false, 207) == "ARENA BRACKET") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 207) == "2v2 Arena"))) || ((twig_get_attribute($this->env, $this->source,                         // line 208
$context["option"], "name", [], "any", false, false, false, 208) == "COACH EXPERIENCE") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 208) == "Multi-Gladiator"))) || ((twig_get_attribute($this->env, $this->source,                         // line 209
$context["option"], "name", [], "any", false, false, false, 209) == "Execution Speed") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 209) == "Regular"))) || ((twig_get_attribute($this->env, $this->source,                         // line 210
$context["option"], "name", [], "any", false, false, false, 210) == "Boost Method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 210) == "Selfplay"))) || ((twig_get_attribute($this->env, $this->source,                         // line 211
$context["option"], "name", [], "any", false, false, false, 211) == "Basic option") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 211) == "70-80 Leveling + 8/8 M+0 Dungeons + 593 ilvl Gear")))) {
                            echo "checked";
                        }
                        echo "/>
\t\t\t\t\t\t\t\t\t\t
...
\t\t\t\t\t";
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 227) == "checkbox")) {
                    // line 228
                    echo "\t\t\t\t\t\t<div class=\"opt-checkbox\" ";
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 228) == "Select Dungeons")) {
                        echo "id=\"hidden-options-checkbox\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 228) == "Specific Slot")) {
                        echo "id=\"specific-gear-slot\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 228) == "Specific Item Slot")) {
...
\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" ";
                        // line 233
                        if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 233), [0 => "Select Dungeons", 1 => "Speecific Item Slot", 2 => "Specific Slot"])) {
...
\t\t\t\t\t";
                ...
                // line 245
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 245) == "text")) {
                    // line 246
...
\t\t\t\t\t";
                ...
                // line 251
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 251) == "textarea")) {
                    // line 252
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t";
                ...
                // line 257
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 257) == "file")) {
                    // line 258
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t";
                ...
                // line 264
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 264) == "date")) {
                    // line 265
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t";
                ...
                // line 275
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 275) == "datetime")) {
                    // line 276
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t";
                ...
                // line 286
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 286) == "time")) {
                    // line 287
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t";
                ...
                // line 297
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 297) == "choice")) {
                    // line 298
                    echo "\t\t\t\t\t  <div class=\"row\">
\t\t\t\t\t\t<div class=\"col-md-12\">
...
<script type=\"text/javascript\">\t
\t\$(document).ready(function () {
\t\t// Функция для проверки радио-кнопок
\t\tfunction checkBoostMethod() {
\t\t\tconst pilotedChecked = \$('input[name=\"option[";
        // line 1944
        echo twig_get_attribute($this->env, $this->source, ($context["option"] ?? null), "product_option_id", [], "any", false, false, false, 1944);
        echo "]\"][data-name=\"Piloted\"]:checked').length > 0;
\t\t\tconst selfplayChecked = \$('input[name=\"option[";
        // line 1945
        echo twig_get_attribute($this->env, $this->source, ($context["option"] ?? null), "product_option_id", [], "any", false, false, false, 1945);
        echo "]\"][data-name=\"Selfplay\"]:checked').length > 0;

\t\t\t// Если оба отмечены, снимаем отметку с Selfplay и ставим на Piloted
\t\t\tif (pilotedChecked && selfplayChecked) {
\t\t\t\t\$('input[name=\"option[";
        // line 1949
        echo twig_get_attribute($this->env, $this->source, ($context["option"] ?? null), "product_option_id", [], "any", false, false, false, 1949);
        echo "]\"][data-name=\"Selfplay\"]').prop('checked', false);
\t\t\t\t\$('input[name=\"option[";
        // line 1950
        echo twig_get_attribute($this->env, $this->source, ($context["option"] ?? null), "product_option_id", [], "any", false, false, false, 1950);
        echo "]\"][data-name=\"Piloted\"]').prop('checked', true);
\t\t\t}
\t\t}

\t\t// Добавляем обработчик событий на все радио-кнопки в группе
\t\t\$('input[type=\"radio\"]').change(checkBoostMethod);
\t});
...
";
    ...
    {
        return array (  4081 => 3550,  2478 => 1950,  2474 => 1949,  2467 => 1945,  2463 => 1944,  2412 => 1896,  2408 => 1895,  2404 => 1894,  1148 => 641,  1141 => 637,  1057 => 556,  1048 => 550,  1040 => 545,  868 => 376,  861 => 372,  853 => 367,  827 => 344,  820 => 340,  816 => 339,  813 => 338,  803 => 332,  798 => 330,  794 => 329,  786 => 324,  782 => 323,  776 => 320,  771 => 317,  768 => 316,  765 => 315,  759 => 314,  754 => 312,  738 => 298,  735 => 297,  721 => 290,  714 => 288,  707 => 287,  704 => 286,  690 => 279,  683 => 277,  676 => 276,  673 => 275,  659 => 268,  652 => 266,  645 => 265,  642 => 264,  634 => 261,  626 => 260,  622 => 259,  615 => 258,  612 => 257,  600 => 254,  594 => 253,  587 => 252,  584 => 251,  572 => 248,  566 => 247,  559 => 246,  556 => 245,  552 => 243,  543 => 239,  536 => 237,  534 => 236,  530 => 235,  524 => 234,  506 => 233,  502 => 231,  498 => 230,  494 => 229,  481 => 228,  479 => 227,  474 => 224,  470 => 222,  461 => 218,  454 => 216,  452 => 215,  448 => 214,  442 => 213,  435 => 211,  434 => 210,  433 => 209,  432 => 208,  431 => 207,  430 => 206,  429 => 205,  428 => 204,  427 => 203,  423 => 202,  419 => 201,  413 => 200,  409 => 199,  405 => 198,  400 => 195,  396 => 194,  392 => 193,  389 => 192,  386 => 191,  377 => 184,  369 => 181,  362 => 179,  360 => 178,  356 => 177,  344 => 176,  341 => 175,  337 => 174,  333 => 173,  319 => 168,  315 => 167,  311 => 166,  307 => 164,  305 => 163,  300 => 162,  295 => 161,  293 => 160,  286 => 155,  283 => 154,  270 => 152,  265 => 151,  263 => 150,  255 => 145,  248 => 141,  242 => 137,  232 => 135,  229 => 134,  219 => 132,  217 => 131,  210 => 126,  206 => 124,  195 => 122,  191 => 121,  188 => 120,  186 => 119,  170 => 106,  164 => 102,  158 => 101,  152 => 99,  144 => 97,  141 => 96,  137 => 95,  130 => 91,  37 => 1,);
    }
