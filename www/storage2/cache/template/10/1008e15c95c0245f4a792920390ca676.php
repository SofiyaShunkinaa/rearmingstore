...
class __TwigTemplate_22250292975cec27ad2efc675c066802 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tvar checkedValues = [];
\t\t\tconsole.log(\"test\"); // Должно выводиться в консоль при изменении чекбокса
