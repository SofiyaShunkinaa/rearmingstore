...
class __TwigTemplate_fcb3bea2c99ee6af44e793e13a6c4728 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t";
        ...
        ";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["option_value"]) {
                        // line 197
                        echo "            ";
                        if (((((((((((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 197) == "Boost Method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 197) == "Piloted")) || ((twig_get_attribute($this->env, $this->source,                         // line 198
$context["option"], "name", [], "any", false, false, false, 198) == "Boost method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 198) == "Piloted (Solo Shuffle)"))) || ((twig_get_attribute($this->env, $this->source,                         // line 199
$context["option"], "name", [], "any", false, false, false, 199) == "Execution options") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 199) == "Full Gear"))) || ((twig_get_attribute($this->env, $this->source,                         // line 200
$context["option"], "name", [], "any", false, false, false, 200) == "EXECUTION OPTIONS") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 200) == "Keystone Hero"))) || ((twig_get_attribute($this->env, $this->source,                         // line 201
$context["option"], "name", [], "any", false, false, false, 201) == "ARENA BRACKET") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 201) == "2v2 Arena"))) || ((twig_get_attribute($this->env, $this->source,                         // line 202
$context["option"], "name", [], "any", false, false, false, 202) == "COACH EXPERIENCE") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 202) == "Multi-Gladiator"))) || ((twig_get_attribute($this->env, $this->source,                         // line 203
$context["option"], "name", [], "any", false, false, false, 203) == "Execution Speed") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 203) == "Regular"))) || (((twig_get_attribute($this->env, $this->source,                         // line 204
$context["option"], "name", [], "any", false, false, false, 204) == "Boost Method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 204) == "Selfplay")) &&  !($context["pilotedSelected"] ?? null))) || ((twig_get_attribute($this->env, $this->source,                         // line 205
$context["option"], "name", [], "any", false, false, false, 205) == "Basic option") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 205) == "70-80 Leveling + 8/8 M+0 Dungeons + 593 ilvl Gear")))) {
                            // line 206
                            echo "
                <input type=\"radio\" 
                    name=\"option[";
                    ...
                    ";
                            // line 213
                            if (((twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 213) == "Piloted") || (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 213) == "Piloted (Solo Shuffle)"))) {
                                // line 214
                                echo "                        ";
                                $context["pilotedSelected"] = true;
                                // line 215
                                echo "                        checked
                    ";
                            }
...
\t\t\t\t\t";
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 232) == "checkbox")) {
                    // line 233
                    echo "\t\t\t\t\t\t<div class=\"opt-checkbox\" ";
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 233) == "Select Dungeons")) {
                        echo "id=\"hidden-options-checkbox\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 233) == "Specific Slot")) {
                        echo "id=\"specific-gear-slot\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 233) == "Specific Item Slot")) {
...
\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" ";
                        // line 238
                        if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 238), [0 => "Select Dungeons", 1 => "Speecific Item Slot", 2 => "Specific Slot"])) {
...
\t\t\t\t\t";
                ...
                // line 250
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 250) == "text")) {
                    // line 251
...
\t\t\t\t\t";
                ...
                // line 256
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 256) == "textarea")) {
                    // line 257
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t";
                ...
                // line 262
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 262) == "file")) {
                    // line 263
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t";
                ...
                // line 269
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 269) == "date")) {
                    // line 270
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t";
                ...
                // line 280
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 280) == "datetime")) {
                    // line 281
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t";
                ...
                // line 302
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 302) == "choice")) {
                    // line 303
                    echo "\t\t\t\t\t  <div class=\"row\">
\t\t\t\t\t\t<div class=\"col-md-12\">
...
";
    ...
    {
        return array (  4067 => 3538,  2427 => 1901,  2423 => 1900,  2419 => 1899,  1163 => 646,  1156 => 642,  1072 => 561,  1063 => 555,  1055 => 550,  883 => 381,  876 => 377,  868 => 372,  842 => 349,  835 => 345,  831 => 344,  828 => 343,  818 => 337,  813 => 335,  809 => 334,  801 => 329,  797 => 328,  791 => 325,  786 => 322,  783 => 321,  780 => 320,  774 => 319,  769 => 317,  753 => 303,  750 => 302,  736 => 295,  729 => 293,  722 => 292,  719 => 291,  705 => 284,  698 => 282,  691 => 281,  688 => 280,  674 => 273,  667 => 271,  660 => 270,  657 => 269,  649 => 266,  641 => 265,  637 => 264,  630 => 263,  627 => 262,  615 => 259,  609 => 258,  602 => 257,  599 => 256,  587 => 253,  581 => 252,  574 => 251,  571 => 250,  567 => 248,  558 => 244,  551 => 242,  549 => 241,  545 => 240,  539 => 239,  521 => 238,  517 => 236,  513 => 235,  509 => 234,  496 => 233,  494 => 232,  488 => 228,  484 => 226,  478 => 225,  474 => 223,  467 => 221,  465 => 220,  461 => 219,  455 => 218,  451 => 216,  447 => 215,  444 => 214,  442 => 213,  438 => 212,  434 => 211,  428 => 210,  424 => 209,  420 => 208,  416 => 206,  414 => 205,  413 => 204,  412 => 203,  411 => 202,  410 => 201,  409 => 200,  408 => 199,  407 => 198,  405 => 197,  401 => 196,  398 => 195,  396 => 194,  392 => 193,  389 => 192,  386 => 191,  377 => 184,  369 => 181,  362 => 179,  360 => 178,  356 => 177,  344 => 176,  341 => 175,  337 => 174,  333 => 173,  319 => 168,  315 => 167,  311 => 166,  307 => 164,  305 => 163,  300 => 162,  295 => 161,  293 => 160,  286 => 155,  283 => 154,  270 => 152,  265 => 151,  263 => 150,  255 => 145,  248 => 141,  242 => 137,  232 => 135,  229 => 134,  219 => 132,  217 => 131,  210 => 126,  206 => 124,  195 => 122,  191 => 121,  188 => 120,  186 => 119,  170 => 106,  164 => 102,  158 => 101,  152 => 99,  144 => 97,  141 => 96,  137 => 95,  130 => 91,  37 => 1,);
    }
