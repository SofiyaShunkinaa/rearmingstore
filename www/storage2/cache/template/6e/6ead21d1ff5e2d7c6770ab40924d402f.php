...
class __TwigTemplate_03c2f84eedf249b364973fa5686c2eb5 extends Template
{
    private $source;
    private $macros = [];
...
\t\t
\tfunction calcTimeByRatingSubstraction(){
\t\tvar current = \$('.dropdown-item[data-name=\"Current RBG rating\"]').data('value').split('-')[1]; 
\t\tvar desired = \$('.dropdown-item[data-name=\"Desired RBG rating\"]').data('value')
\t\tconsole.log(\"current: \" + current + \" desired: \"+desired)\t\t\t\t\t\t\t\t\t\t
...
\t\t\t\t\tbreak;
\t\t\t\tcase [\"RBG Rating Boost\"].includes(productName):
\t\t\t\t
\t\t\t\t    let n = this.dataset.value;
\t\t\t\t\tconsole.log(n);
\t\t\t\t\tcalcTimeByRatingSubstraction();
\t\t\t\t\tbreak;
\t\t\t\t}
\t\t});
\t});
...
\t\t\t\t\tbreak;
\t\t\t\tcase [\"2v2 Arena Rating Boost\"].includes(productName):\t
...
\t\tvar currentR = \$('.dropdown-item[data-name=\"Current RBG rating\"]').first().data('value') == \"0-1000\" ? \"1000\" : \$('.dropdown-item[data-name=\"Current rating\"]').first().data('value');
\t\tvar desiredR = \$('.dropdown-item[data-name=\"Desired RBG rating\"]').first().data('value');
\t\t\t
...
\t\t\t{
\t\t\t\tcurrentRBG = \$(this).first().data('value').split('-')[1];
\t\t\t} else if(optionName == 'Desired RBG rating'){
\t\t\t\tdesiredRBG = \$(this).first().data('value');
\t\t\t}

\t\t\tconsole.log(currentRBG +\" \"+ desiredRBG)

\t\t\tif(document.querySelector('.titlepage').textContent == \"RBG Rating Boost\"){
\t\t\t\tlet delta = desiredRBG - currentRBG;
\t\t\t\tlet time = \"\"
\t\t\t\tconsole.log(delta)
\t\t\t\tif(delta<0 \$ currentRBG>=1200&&currentRBG<=1400){
\t\t\t\t\tif(delta== -100){
\t\t\t\t\t\ttime = \"2 minutes\";
\t\t\t\t\t} else if (dela  == -200){
\t\t\t\t\t\ttime = \"26 minutes\";
...
\t\t\t\tconst ratingData = [
\t\t\t\t\t{ current: 1000, desired: 1200, additional_hours: 24 },
\t\t\t\t\t{ current: 1000, desired: 1300, additional_hours: 0 },
\t\t\t\t\t{ current: 1000, desired: 1400, additional_hours: 0 },
\t\t\t\t\t{ current: 1000, desired: 1500, additional_hours: 24 },
\t\t\t\t\t{ current: 1000, desired: 1600, additional_hours: 48 },
\t\t\t\t\t{ current: 1000, desired: 1700, additional_hours: 24 },
\t\t\t\t\t{ current: 1000, desired: 1800, additional_hours: 48 },
\t\t\t\t\t{ current: 1000, desired: 1900, additional_hours: 24 },
\t\t\t\t\t{ current: 1000, desired: 2000, additional_hours: 24 },
\t\t\t\t\t{ current: 1000, desired: 2100, additional_hours: 48 },

\t\t\t\t\t{ current: 1100, desired: 1200, additional_hours: 24 },
\t\t\t\t\t{ current: 1100, desired: 1300, additional_hours: 0 },\t
\t\t\t\t\t{ current: 1100, desired: 1400, additional_hours: 0 },
\t\t\t\t\t{ current: 1100, desired: 1500, additional_hours: 24 },
\t\t\t\t\t{ current: 1100, desired: 1600, additional_hours: 48 },
\t\t\t\t\t{ current: 1100, desired: 1700, additional_hours: 24 },
\t\t\t\t\t{ current: 1100, desired: 1800, additional_hours: 48 },
\t\t\t\t\t{ current: 1100, desired: 1900, additional_hours: 24 },
\t\t\t\t\t{ current: 1100, desired: 2000, additional_hours: 24 },
\t\t\t\t\t{ current: 1100, desired: 2100, additional_hours: 48 },
\t\t\t\t\t
\t\t\t\t];
\t\t\t
\t\t\t\tfunction getTimeByRating(current, desired) {
