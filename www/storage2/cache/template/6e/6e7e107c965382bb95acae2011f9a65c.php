...
class __TwigTemplate_ba38ad43b7cf829930c3686f2acd0821 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t{
\t\t\t\t\$('#comlete-time-text').text((additional_months+\" months \"+days == 0 ? \"\" : (days == 1 ? days + \" day \" : (days + \" days \")))+ \" order completion\");
\t\t\t}else{
\t\t\t\t\$('#comlete-time-text').text((days == 0 ? \"\" : (days == 1 ? days + \" day \" : (days + \" days \"))) + (hours == 0 ? \"\" : (hours + \" hour\" + (hours != 1 ? \"s\" : \"\"))) + \" order completion\");
\t\t\t}
\t\t\t}
