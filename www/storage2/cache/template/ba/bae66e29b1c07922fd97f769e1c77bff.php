...
class __TwigTemplate_ffd737a52432128331aa4fdb69d94c19 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tadditionalHours += 2;
\t\t}
\t\tif(timeUnits.days=6&&additionalDays==5){
\t\t\tadditionalDays--;
\t\t}
...
\t\t\ttimeUnits.minute = 0;
\t\t}
\t\tif(timeUnits.day>10&&timeUnits.hour<8){
\t\t\tconsole.log(\"test2: \"+timeUnits.day+\" \"+timeUnits.hour)

\t\t\tif(timeUnits.day!=11&&timeUnits.hour!=8){
\t\t\ttimeUnits.hour=0
\t\t\t}
\t\t}else if(timeUnits.day>10&&timeUnits.hour>=8){
\t\t\tconsole.log(\"test\")
\t\t\ttimeUnits.day+=1;
\t\t\ttimeUnits.hour=0;
\t\t}
