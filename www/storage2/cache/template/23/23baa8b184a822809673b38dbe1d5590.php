...
class __TwigTemplate_930c33e97f0c31755e6d1b45fe414c96 extends Template
{
    private $source;
    private $macros = [];
...
\t\tconst maxDays = 30;
\t\tvar text = \"none\";
\t\tif (optionName >= 1 && optionName < 3) {
\t\t\ttext = maxDays - optionName + 1; 
\t\t} else if () {
\t\t\ttext = \"29 days\";
\t\t} else if (optionName >= 3 && optionName <= 9) {
\t\t\ttext = (30 - optionName) + \" days\"; 
\t\t} else if (optionName >= 10 && optionName <= 17) {
\t\t\ttext = (29 - optionName) + \" days\";
\t\t} else if (optionName >= 18 && optionName <= 24) {
\t\t\ttext = (26 - (optionName - 18) * 2) + \" days\";
\t\t}
