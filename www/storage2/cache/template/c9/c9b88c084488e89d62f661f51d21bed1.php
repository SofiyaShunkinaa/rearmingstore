...
class __TwigTemplate_3f29442a44c2cdf3d59994fc8e46dca8 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tconsole.log(\"additionals: \"+ additionals+\"  days: \"+days)
