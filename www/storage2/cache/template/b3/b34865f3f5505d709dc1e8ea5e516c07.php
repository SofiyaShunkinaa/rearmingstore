...
class __TwigTemplate_78edbbeebb02658c213c3655c4c208c2 extends Template
{
    private $source;
    private $macros = [];
...
\t\tdays += additionals;
\t\t
\t\t\$('#comlete-time-text').text(((month == 0 ? \"\" : month+\" months \") + (days == 0 ? \"\" : (days === 1 ? days + \" day \" : (days + \" days \"))) + (hours === 0 ? \"\" : (hours + \" hour\" + (hours !== 1 ? \"s\" : \"\")))) + \" order completion\");\t
\t}\t
