...
class __TwigTemplate_01da9e747c45d13daf2d5e057eeb6585 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tlet extra = parseInt(\$('#comlete-time-text').attr('data-days')) || 0;
\t\t\ttotalWeight+=extra;
\t\t}
