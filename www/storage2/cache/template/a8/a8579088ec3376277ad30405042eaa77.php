...
class __TwigTemplate_9024ca926bf8fcc16793315e6980a8f0 extends Template
{
    private $source;
    private $macros = [];
...
\t\$(document).on('click', '.dropdown-item', function(event) {
    ...
    var selectedName = \$(this).data('name'); // Получаем значение data-name у выбранного элемента
    console.log(\"Selected option name: \" + selectedName);
// Обновляем атрибут data-prise скрытого инпута
});
