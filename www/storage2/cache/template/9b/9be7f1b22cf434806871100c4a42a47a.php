...
class __TwigTemplate_d6e2c6c68cf7226bd8f03cfb7036798c extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\tconsole.log(000)
\t\t\t\tconsole.log(\"current 3v3 rating data: \"+ \$('.dropdown-item[data-name=\"Your current 3v3 rating').data('value'));
\t\t\t}else{
...
\t\t\tconsole.log(\"value: \"+ratingData[rating]);
\t\t}
