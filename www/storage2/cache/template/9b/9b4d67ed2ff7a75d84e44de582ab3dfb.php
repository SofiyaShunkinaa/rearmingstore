...
class __TwigTemplate_5859b2a6ae7fab6e29eb7516f8c97a28 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tconsole.log(000)
\t\t\tlet days = \$('#comlete-time-text').attr('data-current-val') == undefined ? \"35\" : \$('#comlete-time-text').attr('data-current-val');
\t\t\tconsole.log(\"getted days: \", days)
\t\t\tif(count==2){
\t\t\t\tdays+=65
...
\t\t\t\$('.tToRange').css('display', 'flex');
\t\t}else if(product==\"WoW Gladiator Title Boost\"){
\t\t\t\$('#comlete-time-text').text(\"1 month 5 days order completion\");
\t\t\t\$('.tToRange').css('display', 'flex');
\t\t}else{
\t\t\t\$('.tToRange').css('display', 'none');
\t\t}
...
\t\t}
\t\tlet bisPvP = getSelectedCheckboxes(\"option[22469][]\").lenght;
\t\tlet conquest = getSelectedCheckboxes(\"option[22468][]\").lenght;
\t\tif(bisPvP+conquest==2){
\t\t\tdays+=65
\t\t} else if(bisPvP==1){
\t\t\tdays+=60
\t\t} else if(conquest==1){
...
\t\t\t\t\tbreak;
\t\t\t\tcase [\"Full PvP Gear Boost\", \"Honor Gear Boost\"].includes(productName):
\t\t\t\t\t
