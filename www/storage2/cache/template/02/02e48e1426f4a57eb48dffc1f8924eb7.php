...
class __TwigTemplate_85b0877317470f841fedf2a495c35c9c extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tconsole.log(typeof additional_days);
