...
class __TwigTemplate_ed2c4749b44d59dff886171497e019bd extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\tconsole.log(currentR,desiredR,  time)
