...
class __TwigTemplate_d5ebc77a004470ee1d03f170cb3f3b6f extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tdocument.querySelector('.titlepage').textContent == \"WoW Solo Shuffle Boost\") {
\t\t\t
