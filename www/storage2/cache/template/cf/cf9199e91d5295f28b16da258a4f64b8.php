...
class __TwigTemplate_5ad3d38953624a92f3837a841facf2f5 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tconst labelText = \$(this).closest('.checkbigrow').find('label').text().trim();
\t\t\t
\t\t\t// Добавляем объект с информацией о значении и метке в массив
\t\t\tcheckedValues.push({ value, labelText });
\t\t});
