...
class __TwigTemplate_ba00fb264fdac8a1cd69dca667677281 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\tlet hoursTotal = deltaTimes1*6 + deltaTimes2*32;
\t\t\t\tdays = Math.floor(hoursTotal / 24);
\t\t\t\thours = hoursTotal % 24;
\t\t\t}
