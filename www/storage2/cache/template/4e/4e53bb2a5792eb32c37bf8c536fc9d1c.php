...
class __TwigTemplate_8b680ffe16d75d1a34e7526a1840e5e7 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tconsole.log(\"I got  days and hours\", days, hours);
\t\t} 
\t\tvar additionals = \"\";
...
\t\t\tlet additional_days = \$('#comlete-time-text').attr('data-additionals') == \"\" ? \"\" : \$('#comlete-time-text').attr('data-hours');
