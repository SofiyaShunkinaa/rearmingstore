...
class __TwigTemplate_c64834341585d70f47f622be1405809a extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\tcalcTimeByRenownLvl(currentL, desiredL);
\t\t\t}
\t\t\telse{
