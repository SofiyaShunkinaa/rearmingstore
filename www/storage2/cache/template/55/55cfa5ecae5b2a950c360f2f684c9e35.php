...
class __TwigTemplate_29ccbcfbc7cc075b53a6e8afa81f9bd5 extends Template
{
    private $source;
    private $macros = [];
...
\t\tif (selectedRadio.length > 0) {
\t\t\t// Находим label, связанный с выбранной радио-кнопкой по атрибуту \"for\"
\t\t\tconst optionName = \$(`label[for=\"\${selectedRadio.attr('id')}\"]`).text().trim();
\t\t\treturn optionName;
\t\t}
\t\treturn null; 
\t}
...
\t\t};\t
\t\t
\t\tlet method = getSelectedRadioOptionName(23165) == null ? \"Piloted (Solo Shuffle)\" : getSelectedRadioOptionName(22010);
\t\tconsole.log(\"BM: \"+method)
\t\tlet defaultVal=2;
\t\t
\t\tlet totalWeight = values.reduce((total, element) => {
\t\t\tconst weight = weights[element] || 0; 
