...
class __TwigTemplate_2208c27ee346c641e5c22f5b74955245 extends Template
{
    private $source;
    private $macros = [];
...
\tdocument.querySelectorAll('.dropdown-item').forEach(function(item) {
    item.addEventListener('click', function(event) {
        ...
        var optionName = this.dataset.name; // Используем data-атрибут для получения имени
