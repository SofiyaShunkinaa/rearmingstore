...
class __TwigTemplate_fa25f20c3fcabf5f1d0eed1eef3e6bfe extends Template
{
    private $source;
    private $macros = [];
...
\t\tvar current = \$('.dropdown-item[data-name=\"Current RBG rating\"].active').data('value').split('-')[1]; 
