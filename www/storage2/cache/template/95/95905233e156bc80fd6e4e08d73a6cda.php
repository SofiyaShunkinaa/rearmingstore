...
class __TwigTemplate_0faa1fb942b9ae91474a6872f87ec1a1 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\tbreak;
\t\t\t\tcase [\"Wrathion Reputation Boost\", \"Sabellian Reputation Boost\", \"The Cobalt Assembly Reputation Boost\", \"Winterpelt Furbolg Reputation Boost\", \"Conquest Gear Boost\"].includes(productName):
