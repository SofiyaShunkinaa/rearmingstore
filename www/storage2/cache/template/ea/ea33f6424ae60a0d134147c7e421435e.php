...
class __TwigTemplate_5b5f8544d1eabed2671c742b44dab220 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["option_value"]) {
                        // line 142
                        echo "\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t<a class=\"dropdown-item\" id=\"select-option\" href=\"#\" data-id=\"";
                        // line 143
...
\t\tconsole.log(\"Click event triggered!\"); // Проверяем, вызывается ли функция

\t\tvar optionName = \$(this).text();
\t\tconsole.log(\"Option name (text): \" + optionName); // Проверяем текст выбранного элемента

\t\tupdateInfoText(optionName);
\t});
