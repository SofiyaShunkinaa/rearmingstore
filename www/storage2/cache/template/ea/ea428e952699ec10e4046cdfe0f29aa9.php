...
class __TwigTemplate_e837702a3482c4c0a81916aa07acac39 extends Template
{
    private $source;
    private $macros = [];
...
\tfunction countTimeByRating(optionName){
\t\tconst maxDays = 30;
\t\tvar text = \"none\";
\t\tif (optionName == 1) {
\t\t\ttext = \"1 month\"; 
...
\t\t\t\t\tbreak;
\t\t\t\tcase [\"Dragonscale Expedition Reputation Boost\"].includes(productName):
\t\t\t\t\tcountTimeByRating(optionName);
\t\t\t\t\tbreak;
\t\t\t\tcase [\"Dragonscale Expedition Reputation Boost\", 
\t\t\t\t\t\t\"name2\"].includes(productName): // Группируем name1 и name2
\t\t\t\t\t// Вызов функции для name1 и name2
\t\t\t\t\tsomeFunctionForName1AndName2(optionName);
\t\t\t\t\tbreak;
\t\t\t\t}
\t\t\t
\t\t});
