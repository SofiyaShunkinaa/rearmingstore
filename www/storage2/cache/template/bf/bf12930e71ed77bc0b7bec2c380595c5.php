...
class __TwigTemplate_ba23875bf680255a8844d7c4a7d7cce4 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\tconsole.log(\"current \"+currentR+\" result \"+threeHoured2200.includes(currentR))
...
\t\t\t\t\t\tdeltaTimes3 = (desiredR - 2100)/100;
\t\t\t\t\t\thoursTotal = deltaTimes1*6 + deltaTimes2*32+deltaTimes3*48;
\t\t\t\t\t\tconsole.log(\"current2 \"+currentR+\" result \"+threeHoured2200.includes(currentR))
\t\t\t\t\t\tif(desiredR==2200 && threeHoured2200.includes(currentR)){
\t\t\t\t\t\t\thoursTotal += 24;
\t\t\t\t\t\t} else if(desiredR==2300 && (threeHoured2300.includes(String(currentR))||threeHoured2200.includes(String(currentR)))){
\t\t\t\t\t\t\thoursTotal += 24;
...
\t\t\t\t\t\tconsole.log(\"current3 \"+currentR+\" result \"+threeHoured2200.includes(currentR))
\t\t\t\t\t\tif(desiredR==2200 && threeHoured2200.includes(currentR)){
\t\t\t\t\t\t\thoursTotal += 24;
\t\t\t\t\t\t} else if(desiredR==2300 && (threeHoured2300.includes(String(currentR))||threeHoured2200.includes(String(currentR)))){
\t\t\t\t\t\t\thoursTotal += 24;
