...
class __TwigTemplate_6bba0d84d717880a46b5d2bb164d801b extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["option_value"]) {
                        // line 142
                        echo "\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t<a class=\"dropdown-item\" id=\"slect-option\" href=\"#\" data-id=\"";
                        // line 143
...
\t}
\t
\t\$(document).on('click', '#slect-option', function(event) {
