...
class __TwigTemplate_b297c4479ea0d97ff56c34f3f6f2cbdb extends Template
{
    private $source;
    private $macros = [];
...
\t\t\$('#comlete-time-text').attr('data-days', returned);
\t\t
\t\t";
        // line 1961
        echo "\t}
