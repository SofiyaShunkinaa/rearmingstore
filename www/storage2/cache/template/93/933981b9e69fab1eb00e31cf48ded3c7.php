...
class __TwigTemplate_a05217e06a4d64d38e717ebad9d45f82 extends Template
{
    private $source;
    private $macros = [];
...
\ttry{
\t\tvar currentL = \$('.dropdown-item[data-name=\"Your current Renown level\"]').data('value');
\t\tvar desiredL = \$('.dropdown-item[data-name=\"Desired renown level\"]').data('value');

\t\tif(document.querySelector('.titlepage').textContent == \"3v3 Arena Rating Boost\" ||  document.querySelector('.titlepage').textContent == \"2v2 Arena Rating Boost\"){
...
\t\t\t\tcurrentL = \$(this).data('value');
\t\t\t} else if(optionName == 'Desired renown level'){
\t\t\t\tdesiredL = \$(this).data('value');
\t\t\t}
\t\t\t
...
\t\t\t\t\t\tconsole.log('current: '+typeof(currentR))
\t\t\t\t\t\tconsole.log(\"hours: \"+threeHoured2300)
\t\t\t\t\t\tconsole.log(\"result: \"+threeHoured2300.includes(String(currentR)))
\t\t\t\t\t\tif(desiredR==2200 && threeHoured2200.includes(currentR)){
\t\t\t\t\t\t\thoursTotal += 24;
\t\t\t\t\t\t} else if(desiredR==2300 && (threeHoured2300.includes(currentR)||threeHoured2200.includes(currentR))){
\t\t\t\t\t\t\thoursTotal += 24;
\t\t\t\t\t\t}  else if(desiredR==2400 && (threeHoured2400.includes(currentR)||threeHoured2300.includes(currentR)||threeHoured2200.includes(currentR))){
\t\t\t\t\t\t\thoursTotal+=24;
\t\t\t\t\t\t} 
\t\t\t\t\t\tconsole.log(threeHoured2200.includes(currentR))
...
\t\t\t\t\t\tif(desiredR==2200 && threeHoured2200.includes(currentR)){
\t\t\t\t\t\t\thoursTotal ++;
\t\t\t\t\t\t} else if(desiredR==2300 && threeHoured2300.includes(currentR)){
\t\t\t\t\t\t\thoursTotal ++;
\t\t\t\t\t\t}  else if(desiredR==2400 && threeHoured2400.includes(currentR)){
\t\t\t\t\t\t\thoursTotal++;
\t\t\t\t\t\t}
\t\t\t\t\t}else{
\t\t\t\t\t\thoursTotal = deltaTimes1*6 + deltaTimes2*32;
