...
class __TwigTemplate_47fa65f7d5ffb1bfd2e0e6447b53455b extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["breadcrumb"]) {
            // line 101
            echo "\t\t\t\t\t";
            if (twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "href", [], "any", false, false, false, 101)) {
                // line 102
                echo "\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "href", [], "any", false, false, false, 102);
                echo "\"  class=\"breadcrumb-item\">";
                echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "text", [], "any", false, false, false, 102);
                echo "</a>
\t\t\t\t\t";
            } else {
                // line 104
                echo "\t\t\t\t\t\t<span class=\"breadcrumb-item active\">";
                echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "text", [], "any", false, false, false, 104);
                echo "</span>
\t\t\t\t\t";
            }
            // line 106
...
\t\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["prod_cat"]) {
                // line 127
                echo "\t\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["prod_cat"], "href", [], "any", false, false, false, 127);
                echo "\" class=\"btn btn-outline-primary form-check-label\">";
                echo twig_get_attribute($this->env, $this->source, $context["prod_cat"], "text", [], "any", false, false, false, 127);
                echo "</a>
\t\t\t\t\t\t";
            }
            $_parent = $context['_parent'];
...
\t\t\t\t\t\t";
        ...
        if (($context["tags_prod"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["tag_prod"]) {
                // line 157
                echo "\t\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "href", [], "any", false, false, false, 157);
                echo "\" class=\"btn btn-outline-primary form-check-label ";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "active", [], "any", false, false, false, 157);
                echo "\">";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "tag", [], "any", false, false, false, 157);
                echo "</a>
\t\t\t\t\t\t\t";
            }
            $_parent = $context['_parent'];
...
\t\t\t\t";
        ...
        if (($context["options"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
                // line 167
                echo "\t\t\t\t  <h3>";
                echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["option"], "product_option_value", [], "any", false, false, false, 167), "name", [], "any", false, false, false, 167);
                echo "</h3>
\t\t\t\t\t";
                // line 168
...
\t\t\t\t\t\t  <div class=\"borderedRow borderedRow-";
                    // line 171
                    echo twig_get_attribute($this->env, $this->source, $context["option"], "id", [], "any", false, false, false, 171);
                    echo "\">
\t\t\t\t\t\t\t<div>";
                    // line 172
...
\t\t\t\t\t\t\t<input name=\"option[";
                    ...
                    echo twig_get_attribute($this->env, $this->source, ($context["option_value"] ?? null), "name", [], "any", false, false, false, 173);
                    echo "\" data-value=\"";
                    echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["option"], "product_option_value", [], "any", false, false, false, 173), "name", [], "any", false, false, false, 173);
                    echo "\">
...
\t\t\t\t\t\t\t\t\t\t\t";
                        // line 209
                        if (((((((((((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 209) == "Boost Method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 209) == "Piloted")) || ((twig_get_attribute($this->env, $this->source,                         // line 210
$context["option"], "name", [], "any", false, false, false, 210) == "Boost method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 210) == "Piloted (Solo Shuffle)"))) || ((twig_get_attribute($this->env, $this->source,                         // line 211
$context["option"], "name", [], "any", false, false, false, 211) == "Execution options") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 211) == "Full Gear"))) || ((twig_get_attribute($this->env, $this->source,                         // line 212
$context["option"], "name", [], "any", false, false, false, 212) == "EXECUTION OPTIONS") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 212) == "Keystone Hero"))) || ((twig_get_attribute($this->env, $this->source,                         // line 213
$context["option"], "name", [], "any", false, false, false, 213) == "ARENA BRACKET") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 213) == "2v2 Arena"))) || ((twig_get_attribute($this->env, $this->source,                         // line 214
$context["option"], "name", [], "any", false, false, false, 214) == "COACH EXPERIENCE") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 214) == "Multi-Gladiator"))) || ((twig_get_attribute($this->env, $this->source,                         // line 215
$context["option"], "name", [], "any", false, false, false, 215) == "Execution Speed") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 215) == "Regular"))) || ((twig_get_attribute($this->env, $this->source,                         // line 216
$context["option"], "name", [], "any", false, false, false, 216) == "Boost Method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 216) == "Selfplay"))) || ((twig_get_attribute($this->env, $this->source,                         // line 217
$context["option"], "name", [], "any", false, false, false, 217) == "Basic option") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 217) == "70-80 Leveling + 8/8 M+0 Dungeons + 593 ilvl Gear")))) {
                            echo "checked";
                        }
                        echo "/>
\t\t\t\t\t\t\t\t\t\t
...
\t\t\t\t\t";
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 233) == "checkbox")) {
                    // line 234
                    echo "\t\t\t\t\t\t<div class=\"opt-checkbox\" ";
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 234) == "Select Dungeons")) {
                        echo "id=\"hidden-options-checkbox\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 234) == "Specific Slot")) {
                        echo "id=\"specific-gear-slot\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 234) == "Specific Item Slot")) {
...
\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" ";
                        // line 239
                        if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 239), [0 => "Select Dungeons", 1 => "Speecific Item Slot", 2 => "Specific Slot"])) {
...
\t\t\t\t\t";
                ...
                // line 251
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 251) == "text")) {
                    // line 252
...
\t\t\t\t\t";
                ...
                // line 292
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 292) == "time")) {
                    // line 293
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t\t  <input type=\"text\" name=\"option[";
                    ...
                    echo "]\" value=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["option"], "value", [], "any", false, false, false, 296);
...
\t\t\t\t\t";
                ...
                // line 303
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 303) == "choice")) {
                    // line 304
                    echo "\t\t\t\t\t  <div class=\"row\">
\t\t\t\t\t\t<div class=\"col-md-12\">
...
";
    ...
    {
        return array (  4155 => 3632,  1273 => 753,  1266 => 749,  1182 => 668,  1173 => 662,  1165 => 657,  907 => 402,  903 => 401,  899 => 400,  878 => 382,  871 => 378,  863 => 373,  856 => 368,  838 => 350,  831 => 346,  827 => 345,  824 => 344,  814 => 338,  809 => 336,  805 => 335,  797 => 330,  793 => 329,  787 => 326,  782 => 323,  779 => 322,  776 => 321,  770 => 320,  765 => 318,  749 => 304,  746 => 303,  732 => 296,  725 => 294,  718 => 293,  715 => 292,  701 => 285,  694 => 283,  687 => 282,  684 => 281,  670 => 274,  663 => 272,  656 => 271,  653 => 270,  645 => 267,  637 => 266,  633 => 265,  626 => 264,  623 => 263,  611 => 260,  605 => 259,  598 => 258,  595 => 257,  583 => 254,  577 => 253,  570 => 252,  567 => 251,  563 => 249,  554 => 245,  547 => 243,  545 => 242,  541 => 241,  535 => 240,  517 => 239,  513 => 237,  509 => 236,  505 => 235,  492 => 234,  490 => 233,  485 => 230,  481 => 228,  472 => 224,  465 => 222,  463 => 221,  459 => 220,  453 => 219,  446 => 217,  445 => 216,  444 => 215,  443 => 214,  442 => 213,  441 => 212,  440 => 211,  439 => 210,  438 => 209,  434 => 208,  430 => 207,  424 => 206,  420 => 205,  416 => 204,  411 => 201,  407 => 200,  403 => 199,  400 => 198,  397 => 197,  388 => 190,  379 => 186,  367 => 184,  365 => 183,  361 => 182,  349 => 181,  346 => 180,  342 => 179,  338 => 178,  324 => 173,  320 => 172,  316 => 171,  312 => 169,  310 => 168,  305 => 167,  300 => 166,  298 => 165,  291 => 160,  288 => 159,  275 => 157,  270 => 156,  268 => 155,  260 => 150,  253 => 146,  247 => 142,  237 => 140,  234 => 139,  224 => 137,  222 => 136,  215 => 131,  211 => 129,  200 => 127,  196 => 126,  193 => 125,  191 => 124,  175 => 111,  169 => 107,  163 => 106,  157 => 104,  149 => 102,  146 => 101,  142 => 100,  135 => 96,  37 => 1,);
    }
