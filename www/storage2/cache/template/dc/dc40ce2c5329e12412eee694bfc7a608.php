...
class __TwigTemplate_7cac57b07ababa10f75db8aa23ca6d35 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\thoursTotal += 24;
\t\t\t\t\t\t}
\t\t\t\t\t\tif(desiredR==2300 && (threeHoured2300.includes(currentR)||threeHoured2200.includes(currentR))){
\t\t\t\t\t\t\thoursTotal += 24;
\t\t\t\t\t\t}
\t\t\t\t\t\tif(desiredR==2400 && (threeHoured2400.includes(currentR)||threeHoured2300.includes(currentR)||threeHoured2200.includes(currentR))){
\t\t\t\t\t\t\thoursTotal+=24;
\t\t\t\t\t\t}
\t\t\t\t\t}else{
