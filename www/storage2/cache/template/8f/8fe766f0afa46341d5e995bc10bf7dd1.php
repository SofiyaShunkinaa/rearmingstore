...
class __TwigTemplate_36ae28a6643715c7f0d6a243b15be88a extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\tbreak;
\t\t\t\tcase [\"Wrathion Reputation Boost\", \"Sabellian Reputation Boost\", \"The Cobalt Assembly Reputation Boost\"].includes(productName):
