...
class __TwigTemplate_8cdd103dfa782d7c6bd6efc28d02d614 extends Template
{
    private $source;
    private $macros = [];
...
\t\tconst result = ratingData.find(item => item.current === current && item.desired === desired);
    \tconsole.log(\"cur and dis \",current, desired)
