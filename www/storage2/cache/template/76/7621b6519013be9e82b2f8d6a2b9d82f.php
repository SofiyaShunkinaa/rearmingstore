...
class __TwigTemplate_d11bd15b5f3bdf7894faac91ebb8fb13 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tadditionalDays--;
\t\t}
\t\tif(timeUnits.day==10&&additionalHours==8){
\t\t\ttimeUnits.day--;
\t\t}
