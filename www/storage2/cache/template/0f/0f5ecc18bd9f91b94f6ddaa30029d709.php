...
class __TwigTemplate_91474c9028e68e87c7382e1eda9bfeb9 extends Template
{
    private $source;
    private $macros = [];
...
\$(document).ready(function () {
    if (\$('#slider').length > 0) {
        ...
        function updateCompletionText(value) {
            ...
            // Обновление data-prise для каждого элемента <a>
            \$('a[data-base-prise]').each(function () {
