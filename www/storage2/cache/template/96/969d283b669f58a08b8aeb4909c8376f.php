...
class __TwigTemplate_151a609512446ac4b119c8c4fd3e7cc2 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["breadcrumb"]) {
            // line 86
            echo "\t\t\t\t\t";
            if (twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "href", [], "any", false, false, false, 86)) {
                // line 87
                echo "\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "href", [], "any", false, false, false, 87);
                echo "\"  class=\"breadcrumb-item\">";
                echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "text", [], "any", false, false, false, 87);
                echo "</a>
\t\t\t\t\t";
            } else {
                // line 89
...
\t\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["prod_cat"]) {
                // line 112
                echo "\t\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["prod_cat"], "href", [], "any", false, false, false, 112);
                echo "\" class=\"btn btn-outline-primary form-check-label\">";
                echo twig_get_attribute($this->env, $this->source, $context["prod_cat"], "text", [], "any", false, false, false, 112);
                echo "</a>
\t\t\t\t\t\t";
            }
            $_parent = $context['_parent'];
...
\t\t\t\t\t\t";
        ...
        if (($context["tags_prod"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["tag_prod"]) {
                // line 142
                echo "\t\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "href", [], "any", false, false, false, 142);
                echo "\" class=\"btn btn-outline-primary form-check-label ";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "active", [], "any", false, false, false, 142);
                echo "\">";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "tag", [], "any", false, false, false, 142);
                echo "</a>
\t\t\t\t\t\t\t";
            }
            $_parent = $context['_parent'];
...
\t\t\t\t";
        ...
        if (($context["options"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
                // line 152
                echo "\t\t\t\t  <h3>";
                echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["option"], "product_option_value", [], "any", false, false, false, 152), "name", [], "any", false, false, false, 152);
                echo "</h3>
\t\t\t\t\t";
                // line 153
...
\t\t\t\t\t\t  <div class=\"borderedRow borderedRow-";
                    // line 156
                    echo twig_get_attribute($this->env, $this->source, $context["option"], "id", [], "any", false, false, false, 156);
                    echo "\">
\t\t\t\t\t\t\t<div>";
                    // line 157
...
\t\t\t\t\t\t\t<input name=\"option[";
                    ...
                    echo twig_get_attribute($this->env, $this->source, ($context["option_value"] ?? null), "name", [], "any", false, false, false, 158);
                    echo "\" data-value=\"";
                    echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["option"], "product_option_value", [], "any", false, false, false, 158), "name", [], "any", false, false, false, 158);
                    echo "\">
...
\t\t\t\t\t";
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 199) == "checkbox")) {
                    // line 200
                    echo "\t\t\t\t\t\t<div class=\"opt-checkbox\" ";
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 200) == "Select Dungeons")) {
                        echo "id=\"hidden-options-checkbox\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 200) == "Specific Slot")) {
                        echo "id=\"specific-gear-slot\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 200) == "Specific Item Slot")) {
...
\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" ";
                        // line 205
                        if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 205), [0 => "Select Dungeons", 1 => "Speecific Item Slot", 2 => "Specific Slot"])) {
...
\t\t\t\t\t";
                ...
                // line 269
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 269) == "choice")) {
                    // line 270
                    echo "\t\t\t\t\t  <div class=\"row\">
\t\t\t\t\t\t<div class=\"col-md-12\">
...
";
    ...
    {
        return array (  3930 => 3421,  2370 => 1864,  2366 => 1863,  2362 => 1862,  1109 => 612,  1102 => 608,  1018 => 527,  1009 => 521,  1001 => 516,  829 => 347,  822 => 343,  815 => 339,  789 => 316,  782 => 312,  778 => 311,  775 => 310,  765 => 304,  760 => 302,  756 => 301,  748 => 296,  744 => 295,  738 => 292,  733 => 289,  730 => 288,  727 => 287,  721 => 286,  716 => 284,  700 => 270,  697 => 269,  683 => 262,  676 => 260,  669 => 259,  666 => 258,  652 => 251,  645 => 249,  638 => 248,  635 => 247,  621 => 240,  614 => 238,  607 => 237,  604 => 236,  596 => 233,  588 => 232,  584 => 231,  577 => 230,  574 => 229,  562 => 226,  556 => 225,  549 => 224,  546 => 223,  534 => 220,  528 => 219,  521 => 218,  518 => 217,  514 => 215,  505 => 211,  498 => 209,  496 => 208,  492 => 207,  486 => 206,  468 => 205,  464 => 203,  460 => 202,  456 => 201,  443 => 200,  440 => 199,  436 => 197,  427 => 193,  420 => 191,  418 => 190,  414 => 189,  408 => 188,  394 => 187,  390 => 185,  386 => 184,  382 => 183,  379 => 182,  376 => 181,  367 => 174,  359 => 171,  352 => 169,  350 => 168,  346 => 167,  334 => 166,  331 => 165,  327 => 164,  323 => 163,  309 => 158,  305 => 157,  301 => 156,  297 => 154,  295 => 153,  290 => 152,  285 => 151,  283 => 150,  276 => 145,  273 => 144,  260 => 142,  255 => 141,  253 => 140,  245 => 135,  238 => 131,  232 => 127,  222 => 125,  219 => 124,  209 => 122,  207 => 121,  200 => 116,  196 => 114,  185 => 112,  181 => 111,  178 => 110,  176 => 109,  160 => 96,  154 => 92,  148 => 91,  142 => 89,  134 => 87,  131 => 86,  127 => 85,  120 => 81,  37 => 1,);
    }
