...
class __TwigTemplate_b4b8436768887409433b3d042745b6dc extends Template
{
    private $source;
    private $macros = [];
...
\t\tlet month =  Math.floor(totalWeight/30);
