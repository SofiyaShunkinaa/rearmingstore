...
class __TwigTemplate_7cdaa9aecf65354ba3e7eb5e44abe963 extends Template
{
    private $source;
    private $macros = [];
...
\t\tdays = days % 30;
\t\t\$('#comlete-time-text').text((month == 0 ? \"\" : month == 1 ? \"1 month\" : month + \" months\") +days == 0 ? \"\" : (days == 1 ? days + \" day \" : (days + \" days \")) + (hours == 0 ? \"\" : (hours + \" hour\" + (hours != 1 ? \"s\" : \"\"))) + \" order completion\");\t
\t}\t
