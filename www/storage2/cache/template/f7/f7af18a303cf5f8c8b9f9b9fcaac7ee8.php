...
class __TwigTemplate_5fe13607d6c69724aa43c4be6ed9820a extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\tbreak;
\t\t\t\t}
\t\t\t\tcase [\"Azerothian Archives Reputation Boost\",
\t\t\t\t\"2v2 Arena Rating Boost\"].includes(productName):
\t\t\t\t\tcalcTimeByAdditionals();
\t\t\t\t\tbreak;
\t\t\t\t
\t\t});
\t});
...
\tfunction calcTimeByAdditionals(){
