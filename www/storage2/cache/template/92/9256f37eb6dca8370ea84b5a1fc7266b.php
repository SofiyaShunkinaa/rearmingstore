...
class __TwigTemplate_4b246b24b2a31a64c3be1a5eb26bfcbd extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\$('span.price-value').each(function () {
\t\t\t\t\tconst basePrice = parseFloat(\$(this).data('base-prise').replace(/[^\\d.-]/g, '')) || 0;
