...
class __TwigTemplate_c6e4aed918802a5c2fa2da455ec1d0fb extends Template
{
    private $source;
    private $macros = [];
...
\t\t
\t\tconst initialTime = optionName === \"No progress\" ? 0 : 30; 
\t\tconst completionTime = initialTime - optionName; 
...
\t\t\tconst productName  = document.querySelector('.titlepage').text();
\t\t\tconsole.log(productName)
\t\t\tif(optionName.includes(\"free\")){
