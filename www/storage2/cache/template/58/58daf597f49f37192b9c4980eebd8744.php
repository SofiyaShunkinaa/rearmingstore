...
class __TwigTemplate_016d8952b4beeabbb74a412beae1f903 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tdays = \$('#comlete-time-text').attr('data-days', days);
\t\t\thours = \$('#comlete-time-text').attr('data-hours', hours);
\t\t} else{
\t\t\tdays = \$('#comlete-time-text').attr('data-days');
\t\t\thours = \$('#comlete-time-text').attr('data-hours');
\t\t}
\t
\t\tvar additionals = 0;
\t\tif (values.some(function(value) { return value.includes('PvP ilvl'); })) {
        \tadditionals += 2; 
\t\t}
\t\tif (values.some(function(value) { return value.includes('Express'); })) {
\t\t\tadditionals += 0; 
\t\t}
