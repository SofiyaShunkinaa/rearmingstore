...
class __TwigTemplate_27e928b5dcedcdddc4d0e5592adc320b extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t}
\t\t\t\t\tif(currentR==1000&&desiredR==2000){
\t\t\t\t\t\thoursTotal = 96
\t\t\t\t\t}
\t\t\t\t\t
\t\t\t\t\t
