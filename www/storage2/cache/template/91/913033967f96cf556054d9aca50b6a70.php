...
class __TwigTemplate_ce4f03c01e15f414f687525b9b998633 extends Template
{
    private $source;
    private $macros = [];
...
\t\tconst hours = parseInt(\$('#comlete-time-text').attr('data-hours')) || 12; // Получаем часы из элемента
...
\t\t\t\t\t(totalMinutes === 0 ? \"\" : (totalMinutes + \" minute\" + (totalMinutes !== 1 ? \"s\" : \"\"))) + \" order completion\";
\t
\t\tconsole.log(output)
\t\t\$('#comlete-time-text').text(output);
\t}
