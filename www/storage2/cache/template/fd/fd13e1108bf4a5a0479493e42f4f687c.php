...
class __TwigTemplate_b1cf75d6830166c0b49726a2814031e3 extends Template
{
    private $source;
    private $macros = [];
...
\t  <div class=\"form-group\">
\t\t<div class=\"controls\">
\t\t  <label for=\"skype\" class=\"form-check-label\">Skype</label>
\t\t  <input type=\"text\" id=\"skype\" name=\"skype\" value=\"";
        // line 15
        echo ($context["skype"] ?? null);
        echo "\" placeholder=\"skypelogin\"
\t\t\tclass=\"form-control\" />
\t\t  <span class=\"error_skype invalid-feedback\"></span>
\t\t</div>
\t  </div>
\t  <div class=\"form-group\">
\t\t<div class=\"controls\">
...
\t\t  <input type=\"text\" id=\"discord\" name=\"discord\" value=\"";
        ...
        echo "\" placeholder=\"dascordname#1234\"
\t\t\tclass=\"form-control\" />
...
";
    ...
    {
        return array (  112 => 56,  99 => 46,  88 => 38,  78 => 31,  67 => 23,  56 => 15,  45 => 7,  37 => 1,);
    }
