...
class __TwigTemplate_01251ade2a8f226a06142e0a116596e8 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tvar currentR = \$('.dropdown-item[data-name=\"Current rating\"]').data('value');
\t\t\tvar desiredR = \$('.dropdown-item[data-name=\"Desired rating\"]').data('value');
\t\t}
\t\telse{
