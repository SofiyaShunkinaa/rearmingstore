...
class __TwigTemplate_b5b1564c56e7dbe0ce9bde4cf61e1207 extends Template
{
    private $source;
    private $macros = [];
...
\t}
\t
\tfunction calcTimeByEqualExtraOptions(values){
...
\t\t\t\t\tbreak;
\t\t\t\tcase [\"Wrathion Reputation Boost\", \"Sabellian Reputation Boost\"].includes(productName):
\t\t\t\t\tcalcTimeByEqualExtraOptions(checkedValues);
\t\t\t\t\tbreak;
\t\t\t}
\t\t
\t});
