...
class __TwigTemplate_57bd391fe8d597dc8f2b924f0dc09638 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tconsole.log(\$(\"#slider\").attr('data-value'));
\t\t\tvar keystoneLevelPrice = \$('#product input[type=\"hidden\"][data-name=\"Keystone Level\"]').attr('data-prise');
\t\t\tconsole.log(\"keystone value: \"+keystoneLevelPrice)
\t\t\tvar keystoneLevelValue = getNum(keystoneLevelPrice);
\t\t\tall_price += (sliderValue * keystoneLevelValue);
