...
class __TwigTemplate_5d03ca724946cd48f4c8bfdd1b1f9d35 extends Template
{
    private $source;
    private $macros = [];
...
\t\ttotalDays = totalDays % 30; // Оставшиеся дни после выделения месяцев

\t\t// Формируем вывод с учетом месяцев
\t\tlet output = \"\";
