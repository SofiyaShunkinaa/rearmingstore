...
class __TwigTemplate_6abd1fae80095c373e73931941f66962 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\$('#comlete-time-text').attr('data-days', return);
\t\t
\t\tconsole.log(\"additionals: \"+ additionals+\"  days: \"+return+\" hours: \"+hours)
\t}
\t
