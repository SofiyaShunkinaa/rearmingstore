...
class __TwigTemplate_1648a80ca44e754b8193729d27fb9e77 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tlet additional_days = \$('#comlete-time-text').attr('data-hours') == 0 ? \"\" : \$('#comlete-time-text').attr('data-hours');
