...
class __TwigTemplate_950df12f2ae5d0c4f8a8a29e7020bb81 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tconsole.log(\"days:  \"+extraDays+\"hours:  \"+extraHours+\"extraMinutes: \"+minutes);
