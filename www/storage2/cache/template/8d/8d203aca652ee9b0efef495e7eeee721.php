...
class __TwigTemplate_5b55ae492c1f412d6a765a8e8a4e64fd extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t
        ...
        hiddenSummary = result;
\t\tall_price += hiddenSummary/2;
\t\tconsole.log(\"hidden: \"+hiddenSummary)
\t\tconsole.log(\"hidden2: \"+hiddenSummary/2)
    });
\t
