...
class __TwigTemplate_e824ada0646ad7f18ae50d61890f9966 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<div class=\"opt-checkbox_name\">";
            ...
            echo "</div>
\t\t\t\t\t\t\t<div class=\"d-flex flex-column justify-content-centers\">
\t\t\t\t\t\t\t<span id=\"sliderValue\">";
            // line 272
