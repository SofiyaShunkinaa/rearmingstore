...
class __TwigTemplate_06b8cc541f07a2406b3e945a0bfc2d18 extends Template
{
    private $source;
    private $macros = [];
...
.checkbigrow input[type=\"radio\"]:checked + label{
\tbackground-image: url(/img/radio_check.svg);
}
.checkbigrow input[type=\"radio\"] + label{
...
\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["breadcrumb"]) {
            // line 108
            echo "\t\t\t\t\t";
            if (twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "href", [], "any", false, false, false, 108)) {
                // line 109
                echo "\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "href", [], "any", false, false, false, 109);
                echo "\"  class=\"breadcrumb-item\">";
                echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "text", [], "any", false, false, false, 109);
                echo "</a>
\t\t\t\t\t";
            } else {
                // line 111
                echo "\t\t\t\t\t\t<span class=\"breadcrumb-item active\">";
                echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "text", [], "any", false, false, false, 111);
                echo "</span>
\t\t\t\t\t";
            }
            // line 113
...
\t\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["prod_cat"]) {
                // line 134
                echo "\t\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["prod_cat"], "href", [], "any", false, false, false, 134);
                echo "\" class=\"btn btn-outline-primary form-check-label\">";
                echo twig_get_attribute($this->env, $this->source, $context["prod_cat"], "text", [], "any", false, false, false, 134);
                echo "</a>
\t\t\t\t\t\t";
            }
            $_parent = $context['_parent'];
...
\t\t\t\t\t\t";
        ...
        if (($context["tags_prod"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["tag_prod"]) {
                // line 164
                echo "\t\t\t\t\t\t\t<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "href", [], "any", false, false, false, 164);
                echo "\" class=\"btn btn-outline-primary form-check-label ";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "active", [], "any", false, false, false, 164);
                echo "\">";
                echo twig_get_attribute($this->env, $this->source, $context["tag_prod"], "tag", [], "any", false, false, false, 164);
                echo "</a>
\t\t\t\t\t\t\t";
            }
            $_parent = $context['_parent'];
...
\t\t\t\t\t\t  <div class=\"borderedRow borderedRow-";
                    // line 178
                    echo twig_get_attribute($this->env, $this->source, $context["option"], "id", [], "any", false, false, false, 178);
                    echo "\">
\t\t\t\t\t\t\t<div>";
                    // line 179
...
\t\t\t\t\t\t\t<input name=\"option[";
                    ...
                    echo twig_get_attribute($this->env, $this->source, ($context["option_value"] ?? null), "name", [], "any", false, false, false, 180);
                    echo "\" data-value=\"";
...
\t\t\t\t\t\t\t\t\t\t\t";
                        // line 216
                        if (((((((((((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 216) == "Boost Method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 216) == "Piloted")) || ((twig_get_attribute($this->env, $this->source,                         // line 217
$context["option"], "name", [], "any", false, false, false, 217) == "Boost method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 217) == "Piloted (Solo Shuffle)"))) || ((twig_get_attribute($this->env, $this->source,                         // line 218
$context["option"], "name", [], "any", false, false, false, 218) == "Execution options") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 218) == "Full Gear"))) || ((twig_get_attribute($this->env, $this->source,                         // line 219
$context["option"], "name", [], "any", false, false, false, 219) == "EXECUTION OPTIONS") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 219) == "Keystone Hero"))) || ((twig_get_attribute($this->env, $this->source,                         // line 220
$context["option"], "name", [], "any", false, false, false, 220) == "ARENA BRACKET") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 220) == "2v2 Arena"))) || ((twig_get_attribute($this->env, $this->source,                         // line 221
$context["option"], "name", [], "any", false, false, false, 221) == "COACH EXPERIENCE") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 221) == "Multi-Gladiator"))) || ((twig_get_attribute($this->env, $this->source,                         // line 222
$context["option"], "name", [], "any", false, false, false, 222) == "Execution Speed") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 222) == "Regular"))) || ((twig_get_attribute($this->env, $this->source,                         // line 223
$context["option"], "name", [], "any", false, false, false, 223) == "Boost Method") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 223) == "Selfplay"))) || ((twig_get_attribute($this->env, $this->source,                         // line 224
$context["option"], "name", [], "any", false, false, false, 224) == "Basic option") && (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 224) == "70-80 Leveling + 8/8 M+0 Dungeons + 593 ilvl Gear")))) {
                            echo "checked";
                        }
                        echo "/>
\t\t\t\t\t\t\t\t\t\t
...
\t\t\t\t\t";
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 240) == "checkbox")) {
                    // line 241
                    echo "\t\t\t\t\t\t<div class=\"opt-checkbox\" ";
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 241) == "Select Dungeons")) {
                        echo "id=\"hidden-options-checkbox\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 241) == "Specific Slot")) {
                        echo "id=\"specific-gear-slot\"";
                    }
                    if ((twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 241) == "Specific Item Slot")) {
...
\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" ";
                        // line 246
                        if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["option"], "name", [], "any", false, false, false, 246), [0 => "Select Dungeons", 1 => "Speecific Item Slot", 2 => "Specific Slot"])) {
...
\t\t\t\t\t";
                ...
                // line 277
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 277) == "date")) {
                    // line 278
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t";
                ...
                // line 299
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 299) == "time")) {
                    // line 300
                    echo "\t\t\t\t\t  <div class=\"form-group";
...
\t\t\t\t\t";
                ...
                // line 310
                echo "\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 310) == "choice")) {
                    // line 311
                    echo "\t\t\t\t\t  <div class=\"row\">
\t\t\t\t\t\t<div class=\"col-md-12\">
...
";
    ...
    {
        return array (  4162 => 3639,  1280 => 760,  1273 => 756,  1189 => 675,  1180 => 669,  1172 => 664,  914 => 409,  910 => 408,  906 => 407,  885 => 389,  878 => 385,  870 => 380,  863 => 375,  845 => 357,  838 => 353,  834 => 352,  831 => 351,  821 => 345,  816 => 343,  812 => 342,  804 => 337,  800 => 336,  794 => 333,  789 => 330,  786 => 329,  783 => 328,  777 => 327,  772 => 325,  756 => 311,  753 => 310,  739 => 303,  732 => 301,  725 => 300,  722 => 299,  708 => 292,  701 => 290,  694 => 289,  691 => 288,  677 => 281,  670 => 279,  663 => 278,  660 => 277,  652 => 274,  644 => 273,  640 => 272,  633 => 271,  630 => 270,  618 => 267,  612 => 266,  605 => 265,  602 => 264,  590 => 261,  584 => 260,  577 => 259,  574 => 258,  570 => 256,  561 => 252,  554 => 250,  552 => 249,  548 => 248,  542 => 247,  524 => 246,  520 => 244,  516 => 243,  512 => 242,  499 => 241,  497 => 240,  492 => 237,  488 => 235,  479 => 231,  472 => 229,  470 => 228,  466 => 227,  460 => 226,  453 => 224,  452 => 223,  451 => 222,  450 => 221,  449 => 220,  448 => 219,  447 => 218,  446 => 217,  445 => 216,  441 => 215,  437 => 214,  431 => 213,  427 => 212,  423 => 211,  418 => 208,  414 => 207,  410 => 206,  407 => 205,  404 => 204,  395 => 197,  386 => 193,  374 => 191,  372 => 190,  368 => 189,  356 => 188,  353 => 187,  349 => 186,  345 => 185,  331 => 180,  327 => 179,  323 => 178,  319 => 176,  317 => 175,  312 => 174,  307 => 173,  305 => 172,  298 => 167,  295 => 166,  282 => 164,  277 => 163,  275 => 162,  267 => 157,  260 => 153,  254 => 149,  244 => 147,  241 => 146,  231 => 144,  229 => 143,  222 => 138,  218 => 136,  207 => 134,  203 => 133,  200 => 132,  198 => 131,  182 => 118,  176 => 114,  170 => 113,  164 => 111,  156 => 109,  153 => 108,  149 => 107,  142 => 103,  37 => 1,);
    }
