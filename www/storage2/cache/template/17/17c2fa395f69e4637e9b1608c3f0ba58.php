...
class __TwigTemplate_8ee9dc71c7a8ab7ea7733a1313f14841 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tconsole.log(\"Sign: \",\$(this).attr('data-prisePref'))
            if (\$(this).attr('data-prefix') == '-'){ result = -result};
        }
        all_price += result;
    });
