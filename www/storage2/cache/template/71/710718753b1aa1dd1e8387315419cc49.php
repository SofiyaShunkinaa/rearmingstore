...
class __TwigTemplate_8dae251113e4aa21fddb15268c57df2b extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\"Conquest Gear Boost\", \"Wrathion Reputation Boost\", \"Conquest Gear Boost\", \"Honor Gear Boost\"].includes(productName):
