...
class __TwigTemplate_679e1c286f11c9517b7515a3dfc79508 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tlet additional_days = \$('#comlete-time-text').attr('data-additionals') == \"\" ? \"\" : Number(\$('#comlete-time-text').attr('data-additionals'));
\t\t\t 
