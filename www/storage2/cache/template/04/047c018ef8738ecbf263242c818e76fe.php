...
class __TwigTemplate_6f973d57ed8929695bfaab3c7c88323c extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\$('#comlete-time-text').text((days === 0 ? \"\" : (days + (days === 1 ? \" day\" : (days + \" days \")))) + (hours === 0 ? \"\" : (hours + \" hour\" + (hours !== 1 ? \"s\" : \"\"))));
\t\t})
    });
