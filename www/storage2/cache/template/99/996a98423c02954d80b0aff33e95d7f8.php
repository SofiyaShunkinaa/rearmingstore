...
class __TwigTemplate_55e09878d3293697e27f409d7dc7813d extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t
\t\t\tif(document.querySelector('.titlepage').textContent == \"RBG Rating Boost\" || document.querySelector('.titlepage').textContent == \"WoW Solo Shuffle Boost\"){
