...
class __TwigTemplate_c4c144e6c9e7c73efe182f980e7d1694 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\ttotalWeight--;
\t\t} else if(document.querySelector('.titlepage').textContent==\"Elite PvP Gear Boost\"){
\t\t\ttotalWeight+=2;
\t\t}
...
\t\t}
\t\tif(document.querySelector('.titlepage').textContent==\"Elite PvP Gear Boost\"&&count==0){
...
\t\t\t\t\"Conquest Gear Boost\", \"Wrathion Reputation Boost\", \"Conquest Gear Boost\"].includes(productName):
