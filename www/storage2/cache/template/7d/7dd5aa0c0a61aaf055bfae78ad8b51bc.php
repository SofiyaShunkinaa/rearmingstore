...
class __TwigTemplate_b3313bf8b684c9e690093b5f9679fcbb extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tconsole.log(000)
\t\t\tlet days = \$('#comlete-time-text').attr('data-current-val') == \"\" ? \"35\" : \$('#comlete-time-text').attr('data-current-val');
