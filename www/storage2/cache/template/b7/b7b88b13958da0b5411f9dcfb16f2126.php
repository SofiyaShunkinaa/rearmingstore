...
class __TwigTemplate_c87a3e8883f5b67ebbd3789648607b61 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\tconsole.log(\"fff\");
\t\t\t\t    let new = \$('.dropdown-item[data-name=\"Desired RBG rating\"]').data('value');
\t\t\t\t\t
\t\t\t\t\tcalcTimeByRatingSubstraction(null,new);
\t\t\t\t\tbreak;
\t\t\t\t}
\t\t});
\t});
