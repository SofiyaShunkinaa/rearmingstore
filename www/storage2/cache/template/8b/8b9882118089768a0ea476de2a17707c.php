...
class __TwigTemplate_86f78b414f3723b9389f36f9e9200edd extends Template
{
    private $source;
    private $macros = [];
    ...
    if (\$('#slider').length > 0) {
        ...
        function updateCompletionText(value) {
            ...
            if (document.querySelector('.titlepage').textContent === \"WoW Solo Shuffle Wins Boost\") {
                ...
                updatedPrice = \$('.option-price').data('base-prise') * value;
                \$('.option-price').attr('data-prise', updatedPrice);
