...
class __TwigTemplate_99bf6d36f315879b06940c5e10e03498 extends Template
{
    private $source;
    private $macros = [];
...
\t\tsetTimeText(\"3 hours order completion\");
\t\t} else if (optionName.includes(\"(x6 + 2 free)\")) {
\t\tsetTimeText(\"6 hours order completion\");
\t\t} else {
\t\tsetTimeText(\"3 hours order completion\"); 
\t\t}
\t}
...
\t\tsetTimeText(days + \" day \" + (hours === 0 ? \"\" : (hours + \" hour\" + (hours !== 1 ? \"s\" : \"\"))));
\t}
...
\t\t\ttext = \"1 day\";
\t\t}
\t\tsetTimeText(text+\" order completion\");
\t}
...
\t\t\tsetTimeText(text+\" days order completion\");
\t\t} else{
