...
class __TwigTemplate_d7636cb58cae0b328e23fd49fce0c708 extends Template
{
    private $source;
    private $macros = [];
...
\t\tconst totalHours = values.reduce((total, element) => {
...
\t\tconsole.log(`Total time: \${days} day(s), \${hours} hour(s), \${minutes} minute(s)`);
\t}
...
\t\t\t\t\tbreak;
\t\t\t\tcase [\"The War Within Level Boost\"].includes(productName):
...
\t\tif(\$('.dropdown-item[data-name=\"Your current Renown level\"]').length > 0){
...
\t\t\tvar currentR = \$('.dropdown-item[data-name=\"current Level\"]').data('value');
\t\t\tvar desiredR = \$('.dropdown-item[data-name=\"Desired level\"]').data('value');
\t\t}
\t\telse{
...
\t\t\t\tvar currentR = \$(this).data('value');
\t\t\t} else if(optionName == 'Desired level'){
\t\t\t\tvar desiredR = \$(this).data('value');
\t\t\t}
\t\t\tconsole.log(currentR,  desiredR)
\t\t\t
