...
class __TwigTemplate_7c9709106f77fbb25cc17da5dc1c60c8 extends Template
{
    private $source;
    private $macros = [];
...
\tfunction countTimeByProgress(optionName){
\t\t
\t\tconst initialTime = 30; 
\t\tconst optionValue = optionName === \"No progress\" ? 0 : optionName[0]; 
...
\tfunction countTimeByGroupedRating(optionName){
\t\tconst maxDays = 30;
\t\tvar text = \"none\";
\t\tif (optionName == 1) {
\t\t\ttext = \"1 month\"; 
\t\t} else if (optionName == 2 || optionName == 3) {
\t\t\ttext = (maxDays - optionName + 1) +\" days\";
\t\t} else if (optionName > 3 && optionName <= 8) {
\t\t\ttext = (maxDays - optionName) + \" days\"; 
\t\t} else if (optionName > 8 && optionName <= 13) {
\t\t\ttext = (maxDays - optionName -1) + \" days\";
\t\t} else if (optionName > 13 && optionName <= 17) {
\t\t\ttext = (maxDays - optionName - 2) + \" days\";
\t\t} else if (optionName > 17  && optionName <= 22) {
\t\t\ttext = (maxDays - optionName - 3) + \" days\";
\t\t} else if(optionName == 23){
\t\t\ttext = \"3 days\";
\t\t} else if( optionName == 24){
\t\t\ttext = \"1 day\";
\t\t}
\t\t\$('#comlete-time-text').text(text+\" order completion\");
\t}

\tfunction countTimeByGroupedRating2(optionName){
\t\tconst maxDays = 23;
\t\tvar text = \"none\";
\t\tif (optionName == 19) {
\t\t\ttext = \"1 day\"
\t\t}
\t\telse if(1<= optionName < 6){
\t\t\ttext = (maxDays - optionName) +\" days\";
\t\t}
\t\telse if(6 <= optionName < 16){
\t\t\ttext = (maxDays - optionName -1) +\" days\";
\t\t}
\t\telse if(16 <= optionName < 19){
\t\t\ttext =  (maxDays - optionName - 2) +\" days\";
\t\t}
\t\t\$('#comlete-time-text').text(text+\" order completion\");
\t}

\tfunction countTimeByIteratedRating(optionName){
\t\tconst maxDays = 31;
\t\tvar text = \"none\";
\t\tif (optionName == 1) {
\t\t\ttext = \"1 month\"
\t\t} else if(optionName == 29){
\t\t\ttext = \"1 day\"
\t\t}
\t\telse{
\t\t\ttext =  (maxDays - optionName) + \" days\";
...
\t
\t// updateTimeToCompleteText function
...
\t\t\t\t\tbreak;
\t\t\t\tcase [\"Dragonscale Expedition Reputation Boost\", \"The Maruuk Centaur Reputation Boost\"].includes(productName):
...
";
    ...
    {
        return array (  2368 => 1922,  1009 => 566,  1002 => 562,  918 => 481,  909 => 475,  901 => 470,  729 => 301,  722 => 297,  715 => 293,  689 => 270,  682 => 266,  677 => 265,  674 => 264,  668 => 263,  663 => 261,  647 => 247,  644 => 246,  630 => 239,  623 => 237,  616 => 236,  613 => 235,  599 => 228,  592 => 226,  585 => 225,  582 => 224,  568 => 217,  561 => 215,  554 => 214,  551 => 213,  543 => 210,  535 => 209,  531 => 208,  524 => 207,  521 => 206,  509 => 203,  503 => 202,  496 => 201,  493 => 200,  481 => 197,  475 => 196,  468 => 195,  465 => 194,  461 => 192,  452 => 188,  445 => 186,  443 => 185,  439 => 184,  433 => 183,  421 => 182,  417 => 180,  413 => 179,  409 => 178,  406 => 177,  403 => 176,  399 => 174,  390 => 170,  383 => 168,  381 => 167,  377 => 166,  371 => 165,  359 => 164,  355 => 162,  351 => 161,  347 => 160,  344 => 159,  341 => 158,  332 => 151,  324 => 148,  317 => 146,  315 => 145,  311 => 144,  301 => 143,  298 => 142,  294 => 141,  290 => 140,  280 => 135,  276 => 134,  271 => 131,  268 => 130,  263 => 129,  261 => 128,  254 => 123,  251 => 122,  238 => 120,  233 => 119,  231 => 118,  223 => 113,  216 => 109,  210 => 105,  200 => 103,  197 => 102,  187 => 100,  185 => 99,  178 => 94,  174 => 92,  163 => 90,  159 => 89,  156 => 88,  154 => 87,  138 => 74,  132 => 70,  126 => 69,  120 => 67,  112 => 65,  109 => 64,  105 => 63,  98 => 59,  37 => 1,);
    }
