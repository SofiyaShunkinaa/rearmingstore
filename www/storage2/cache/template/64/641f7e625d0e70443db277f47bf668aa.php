...
class __TwigTemplate_e2597f7d731d554980d4d9660ca13369 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t}
\t\t\tif (values.some(function(value) { return value.includes('PvP Gear'); })) {
\t\t\t\tadditionalMonths = Number(2); 
\t\t\t}
\t\t}
\t
\t\t\$('#comlete-time-text').attr('data-additionals', additionals);
\t\t\$('#comlete-time-text').attr('data-additionals-months', additionalMonths);
\t
\t\tdays += additionals;
\t\t
\t\t\$('#comlete-time-text').text(((additionalMonths == 0 ? \"\" : additionalMonths+\" months \") + (days == 0 ? \"\" : (days === 1 ? days + \" day \" : (days + \" days \"))) + (hours === 0 ? \"\" : (hours + \" hour\" + (hours !== 1 ? \"s\" : \"\")))) + \" order completion\");\t
\t}\t
...
\t\t\t\$('#comlete-time-text').text(((additional_months == 0 ? \"\" : additional_months+\" months \")days == 0 ? \"\" : (days == 1 ? days + \" day \" : (days + \" days \"))) + (hours == 0 ? \"\" : (hours + \" hour\" + (hours != 1 ? \"s\" : \"\"))) + \" order completion\");
\t\t\t}
\t\t})
    });
