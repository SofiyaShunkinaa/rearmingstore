...
class __TwigTemplate_9f2ca92affbe97e60c0219b6438e6467 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tlet additional_days = \$('#comlete-time-text').attr('data-additionals') == 0 ? \"\" : \$('#comlete-time-text').attr('data-hours');
