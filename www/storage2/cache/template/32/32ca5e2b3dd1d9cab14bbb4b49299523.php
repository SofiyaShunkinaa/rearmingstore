...
class __TwigTemplate_f17b40677f54cc2b236c402638d4f09e extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\tconsole.log(\"and: \"+(threeHoured2300.includes(currentR)||threeHoured2200.includes(currentR)))
