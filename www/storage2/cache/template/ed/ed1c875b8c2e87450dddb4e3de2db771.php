...
class __TwigTemplate_ed7803b1c762872e06142cbd00f5c552 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t'BiS PvP Gear for Current Meta': 5,
\t\t\t'Conquest Gear (ilvl 639)': 60,
...
\t\t\t\t\tbreak;
\t\t\t\tcase [\"Full PvP Gear Boost\"].includes(checkedValues):
