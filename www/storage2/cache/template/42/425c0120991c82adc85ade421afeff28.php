...
class __TwigTemplate_e6bb57e9ca80737db2a052c10eecfba2 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\tif(desiredR<1900 && desiredR != \"1400\" && currentR > \"1400\"){
\t\t\t\tdeltaTimes = (desiredR - 1400)/100;
\t\t\t\thoursTotal = deltaTimes*6;
\t\t\t} else if(desiredR>=1900 && desiredR != \"1400\" && currentR > \"1400\"){
