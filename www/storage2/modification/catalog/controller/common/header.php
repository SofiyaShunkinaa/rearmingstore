...
class ControllerCommonHeader extends Controller {
    public function index(): string {
        ...
        $data['products_wishlist'] = $this->load->controller('common/favorites');


        $data['w3creators_css'] = html_entity_decode($this->config->get('config_w3creators_custom_css') ? $this->config->get('config_w3creators_custom_css') : '', ENT_QUOTES, 'UTF-8');
        $data['w3creators_custom_head'] = html_entity_decode($this->config->get('config_w3creators_custom_head') ? $this->config->get('config_w3creators_custom_head') : '', ENT_QUOTES, 'UTF-8');
