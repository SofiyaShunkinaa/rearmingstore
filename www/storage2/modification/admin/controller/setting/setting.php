...
class ControllerSettingSetting extends Controller {
    ...
    public function index(): void {
        ...
        if (isset($this->request->post['config_f_mail'])) {
            $data['config_f_mail'] = $this->request->post['config_f_mail'];
        } else {
            $data['config_f_mail'] = $this->config->get('config_f_mail');
        }

        if (isset($this->request->post['config_f_phone'])) {
            $data['config_f_phone'] = $this->request->post['config_f_phone'];
        } else {
            $data['config_f_phone'] = $this->config->get('config_f_phone');
        }

        if (isset($this->request->post['config_f_tg'])) {
            $data['config_f_tg'] = $this->request->post['config_f_tg'];
        } else {
            $data['config_f_tg'] = $this->config->get('config_f_tg');
        }
        if (isset($this->request->post['config_f_inst'])) {
            $data['config_f_inst'] = $this->request->post['config_f_inst'];
        } else {
            $data['config_f_inst'] = $this->config->get('config_f_inst');
        }
        ...
        if (isset($this->request->post['config_w3creators_custom_css'])) {
          $data['config_w3creators_custom_css'] = $this->request->post['config_w3creators_custom_css'];
        } else {
          $data['config_w3creators_custom_css'] = html_entity_decode($this->config->get('config_w3creators_custom_css'), ENT_QUOTES, 'UTF-8');
        }
        if (isset($this->request->post['config_w3creators_custom_js'])) {
          $data['config_w3creators_custom_js'] = $this->request->post['config_w3creators_custom_js'];
        } else {
          $data['config_w3creators_custom_js'] = html_entity_decode($this->config->get('config_w3creators_custom_js'), ENT_QUOTES, 'UTF-8');
        }
        if (isset($this->request->post['config_w3creators_custom_head'])) {
          $data['config_w3creators_custom_head'] = $this->request->post['config_w3creators_custom_head'];
        } else {
          $data['config_w3creators_custom_head'] = html_entity_decode($this->config->get('config_w3creators_custom_head'), ENT_QUOTES, 'UTF-8');
        }
